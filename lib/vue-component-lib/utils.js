...
export const defineContainer = (name, defineCustomElement, componentProps = [], modelProp = 'value', modelUpdateEvent, externalModelUpdateEvent) => {
    ...
    const Container = defineComponent((props, { attrs, slots, emit }) => {
        ...
        const onVnodeBeforeMount = (vnode) => {
            if (vnode.el) {
                wppEvents.forEach((eventName) => {
                    vnode.el.addEventListener(eventName, (e) => {
