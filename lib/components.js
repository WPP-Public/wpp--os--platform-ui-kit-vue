...
export const WppAccordion = defineContainer('wpp-accordion-v4-2-0', defineWppAccordion, [
    'expandedByDefault',
    'expanded',
    'disabled',
    'withDivider',
...
export const WppActionButton = defineContainer('wpp-action-button-v4-2-0', defineWppActionButton, [
    'disabled',
    'loading',
    'variant',
    'autoFocus',
...
export const WppArtefact = defineContainer('wpp-artefact-v4-2-0', defineWppArtefact, [
    'size',
    'artefactTitle',
    'actions',
    'withPinAction',
...
export const WppAutocomplete = defineContainer('wpp-autocomplete-v4-2-0', defineWppAutocomplete, [
    'labelConfig',
    'name',
    'autoFocus',
    'disabled',
...
export const WppAvatar = defineContainer('wpp-avatar-v4-2-0', defineWppAvatar, [
    'name',
    'size',
    'variant',
    'src',
...
export const WppAvatarGroup = defineContainer('wpp-avatar-group-v4-2-0', defineWppAvatarGroup, [
    'avatars',
    'maxAvatarsToDisplay',
    'size',
    'variant',
...
export const WppBackToTopButton = defineContainer('wpp-back-to-top-button-v4-2-0', defineWppBackToTopButton, [
    'ariaProps'
]);
export const WppBanner = defineContainer('wpp-banner-v4-2-0', defineWppBanner, [
    'ariaProps',
    'role',
    'show',
    'closable',
...
export const WppBasicNode = defineContainer('wpp-basic-node-v4-2-0', defineWppBasicNode, [
    'nodeTitle',
    'isLoading',
    'actions',
    'locales',
...
export const WppBreadcrumb = defineContainer('wpp-breadcrumb-v4-2-0', defineWppBreadcrumb, [
    'items',
    'maxLabelLength',
    'middleTruncation',
    'nativeLink',
...
export const WppButton = defineContainer('wpp-button-v4-2-0', defineWppButton, [
    'size',
    'disabled',
    'loading',
    'variant',
...
export const WppCard = defineContainer('wpp-card-v4-2-0', defineWppCard, [
    'variant',
    'value',
    'size',
    'type',
...
export const WppCardGroup = defineContainer('wpp-card-group-v4-2-0', defineWppCardGroup, [
    'name',
    'size',
    'value',
    'multiple',
...
export const WppChatAlert = defineContainer('wpp-chat-alert-v4-2-0', defineWppChatAlert, [
    'type',
    'message',
    'description',
    'closable',
...
export const WppChatConversation = defineContainer('wpp-chat-conversation-v4-2-0', defineWppChatConversation, [
    'messages',
...
export const WppChatConversationMessage = defineContainer('wpp-chat-conversation-message-v4-2-0', defineWppChatConversationMessage, [
    'role',
    'content',
    'status',
    'actionButtonsConfig',
...
export const WppChatInput = defineContainer('wpp-chat-input-v4-2-0', defineWppChatInput, [
    'size',
    'placeholder',
    'enableAttach',
    'enableMic',
...
export const WppChatNode = defineContainer('wpp-chat-node-v4-2-0', defineWppChatNode, [
    'nodeTitle',
    'titleIcon',
    'isLoading',
    'isSelected',
...
export const WppChatReference = defineContainer('wpp-chat-reference-v4-2-0', defineWppChatReference, [
    'type',
    'name',
    'fileType',
    'src',
...
export const WppChatThinking = defineContainer('wpp-chat-thinking-v4-2-0', defineWppChatThinking, [
    'label'
]);
export const WppCheckbox = defineContainer('wpp-checkbox-v4-2-0', defineWppCheckbox, [
    'name',
    'value',
    'checked',
    'controlled',
...
export const WppCheckboxGroup = defineContainer('wpp-checkbox-group-v4-2-0', defineWppCheckboxGroup, [
    'value',
    'required',
    'message',
    'messageType',
...
export const WppColorPicker = defineContainer('wpp-color-picker-v4-2-0', defineWppColorPicker, [
    'initialColor',
    'dropdownConfig',
    'type',
    'mode',
...
export const WppCounter = defineContainer('wpp-counter-v4-2-0', defineWppCounter, [
    'name',
    'value',
    'min',
    'max',
...
export const WppDatepicker = defineContainer('wpp-datepicker-v4-2-0', defineWppDatepicker, [
    'range',
    'toggleSelected',
    'value',
    'autoFocus',
...
export const WppDivider = defineContainer('wpp-divider-v4-2-0', defineWppDivider, [
    'vertical',
    'resizable'
]);
export const WppEmpty404 = defineContainer('wpp-empty-404-v4-2-0', defineWppEmpty404, [
    'width',
    'height'
]);
export const WppEmptyCards = defineContainer('wpp-empty-cards-v4-2-0', defineWppEmptyCards, [
    'width',
    'height'
]);
export const WppEmptyContent = defineContainer('wpp-empty-content-v4-2-0', defineWppEmptyContent, [
    'width',
    'height'
]);
export const WppEmptyDataviz = defineContainer('wpp-empty-dataviz-v4-2-0', defineWppEmptyDataviz, [
    'width',
    'height'
]);
export const WppEmptyDowntime = defineContainer('wpp-empty-downtime-v4-2-0', defineWppEmptyDowntime, [
    'width',
    'height'
]);
export const WppEmptyError = defineContainer('wpp-empty-error-v4-2-0', defineWppEmptyError, [
    'width',
    'height'
]);
export const WppEmptyFolder = defineContainer('wpp-empty-folder-v4-2-0', defineWppEmptyFolder, [
    'width',
    'height'
]);
export const WppEmptyNoAccess = defineContainer('wpp-empty-no-access-v4-2-0', defineWppEmptyNoAccess, [
    'width',
    'height'
]);
export const WppEmptyNoConnection = defineContainer('wpp-empty-no-connection-v4-2-0', defineWppEmptyNoConnection, [
    'width',
    'height'
]);
export const WppEmptyNothingFound = defineContainer('wpp-empty-nothing-found-v4-2-0', defineWppEmptyNothingFound, [
    'width',
    'height'
]);
export const WppEmptyNotifications = defineContainer('wpp-empty-notifications-v4-2-0', defineWppEmptyNotifications, [
    'width',
    'height'
]);
export const WppEmptyTable = defineContainer('wpp-empty-table-v4-2-0', defineWppEmptyTable, [
    'width',
    'height'
]);
export const WppExpandableCard = defineContainer('wpp-expandable-card-v4-2-0', defineWppExpandableCard, [
    'expandedByDefault',
    'isExpanded',
    'size',
    'variant',
...
export const WppFileUpload = defineContainer('wpp-file-upload-v4-2-0', defineWppFileUpload, [
    'name',
    'value',
    'disabled',
    'multiple',
...
export const WppFileUploadItem = defineContainer('wpp-file-upload-item-v4-2-0', defineWppFileUploadItem, [
    'fileName',
    'file',
    'format',
    'currentIndex',
...
export const WppFilterButton = defineContainer('wpp-filter-button-v4-2-0', defineWppFilterButton, [
    'counter',
    'name',
    'ariaProps',
    'disabled',
...
export const WppFloatingButton = defineContainer('wpp-floating-button-v4-2-0', defineWppFloatingButton, [
    'disabled',
    'loading',
    'autoFocus',
    'name',
...
export const WppFloatingToolbar = defineContainer('wpp-floating-toolbar-v4-2-0', defineWppFloatingToolbar, [
    'actionButtonsConfig',
    'selectable',
    'orientation',
    'ariaProps'
]);
export const WppFullScreenModal = defineContainer('wpp-full-screen-modal-v4-2-0', defineWppFullScreenModal, [
    'open',
...
export const WppGrid = defineContainer('wpp-grid-v4-2-0', defineWppGrid, [
    'container',
    'item',
    'direction',
    'justifyContent',
...
export const WppHandle = defineContainer('wpp-handle-v4-2-0', defineWppHandle, [
    'type',
    'isSelected',
    'isLoading',
    'color'
]);
export const WppIconAbout = defineContainer('wpp-icon-about-v4-2-0', defineWppIconAbout, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAccessibility = defineContainer('wpp-icon-accessibility-v4-2-0', defineWppIconAccessibility, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAccordion = defineContainer('wpp-icon-accordion-v4-2-0', defineWppIconAccordion, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAction = defineContainer('wpp-icon-action-v4-2-0', defineWppIconAction, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAdd = defineContainer('wpp-icon-add-v4-2-0', defineWppIconAdd, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAddApp = defineContainer('wpp-icon-add-app-v4-2-0', defineWppIconAddApp, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAddCircle = defineContainer('wpp-icon-add-circle-v4-2-0', defineWppIconAddCircle, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAddDocument = defineContainer('wpp-icon-add-document-v4-2-0', defineWppIconAddDocument, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAddFolder = defineContainer('wpp-icon-add-folder-v4-2-0', defineWppIconAddFolder, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAdmin = defineContainer('wpp-icon-admin-v4-2-0', defineWppIconAdmin, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAi = defineContainer('wpp-icon-ai-v4-2-0', defineWppIconAi, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAirPollution = defineContainer('wpp-icon-air-pollution-v4-2-0', defineWppIconAirPollution, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAirplane = defineContainer('wpp-icon-airplane-v4-2-0', defineWppIconAirplane, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAngry = defineContainer('wpp-icon-angry-v4-2-0', defineWppIconAngry, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconApp = defineContainer('wpp-icon-app-v4-2-0', defineWppIconApp, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAppFolder = defineContainer('wpp-icon-app-folder-v4-2-0', defineWppIconAppFolder, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAppStore = defineContainer('wpp-icon-app-store-v4-2-0', defineWppIconAppStore, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconApprovals = defineContainer('wpp-icon-approvals-v4-2-0', defineWppIconApprovals, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconArchive = defineContainer('wpp-icon-archive-v4-2-0', defineWppIconArchive, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconArchiveMultiple = defineContainer('wpp-icon-archive-multiple-v4-2-0', defineWppIconArchiveMultiple, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconArrow = defineContainer('wpp-icon-arrow-v4-2-0', defineWppIconArrow, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconAsk = defineContainer('wpp-icon-ask-v4-2-0', defineWppIconAsk, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAssistant = defineContainer('wpp-icon-assistant-v4-2-0', defineWppIconAssistant, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAtm = defineContainer('wpp-icon-atm-v4-2-0', defineWppIconAtm, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAttach = defineContainer('wpp-icon-attach-v4-2-0', defineWppIconAttach, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAutoSum = defineContainer('wpp-icon-auto-sum-v4-2-0', defineWppIconAutoSum, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAutofit = defineContainer('wpp-icon-autofit-v4-2-0', defineWppIconAutofit, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconAutofitHeight = defineContainer('wpp-icon-autofit-height-v4-2-0', defineWppIconAutofitHeight, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAutofitHeightDotted = defineContainer('wpp-icon-autofit-height-dotted-v4-2-0', defineWppIconAutofitHeightDotted, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAutofitWidth = defineContainer('wpp-icon-autofit-width-v4-2-0', defineWppIconAutofitWidth, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAutofitWidthDotted = defineContainer('wpp-icon-autofit-width-dotted-v4-2-0', defineWppIconAutofitWidthDotted, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAvailableCheckmark = defineContainer('wpp-icon-available-checkmark-v4-2-0', defineWppIconAvailableCheckmark, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAvailableUpdate = defineContainer('wpp-icon-available-update-v4-2-0', defineWppIconAvailableUpdate, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBank = defineContainer('wpp-icon-bank-v4-2-0', defineWppIconBank, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBar = defineContainer('wpp-icon-bar-v4-2-0', defineWppIconBar, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBarChart = defineContainer('wpp-icon-bar-chart-v4-2-0', defineWppIconBarChart, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBarHorizontal = defineContainer('wpp-icon-bar-horizontal-v4-2-0', defineWppIconBarHorizontal, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBicycle = defineContainer('wpp-icon-bicycle-v4-2-0', defineWppIconBicycle, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBlockquote = defineContainer('wpp-icon-blockquote-v4-2-0', defineWppIconBlockquote, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBluetoothOff = defineContainer('wpp-icon-bluetooth-off-v4-2-0', defineWppIconBluetoothOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBluetoothOn = defineContainer('wpp-icon-bluetooth-on-v4-2-0', defineWppIconBluetoothOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBoard = defineContainer('wpp-icon-board-v4-2-0', defineWppIconBoard, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBold = defineContainer('wpp-icon-bold-v4-2-0', defineWppIconBold, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBook = defineContainer('wpp-icon-book-v4-2-0', defineWppIconBook, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBookContacts = defineContainer('wpp-icon-book-contacts-v4-2-0', defineWppIconBookContacts, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBookFaq = defineContainer('wpp-icon-book-faq-v4-2-0', defineWppIconBookFaq, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBookInformation = defineContainer('wpp-icon-book-information-v4-2-0', defineWppIconBookInformation, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBookSearch = defineContainer('wpp-icon-book-search-v4-2-0', defineWppIconBookSearch, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBookmark = defineContainer('wpp-icon-bookmark-v4-2-0', defineWppIconBookmark, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBookmarkAdd = defineContainer('wpp-icon-bookmark-add-v4-2-0', defineWppIconBookmarkAdd, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBookmarkSelected = defineContainer('wpp-icon-bookmark-selected-v4-2-0', defineWppIconBookmarkSelected, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBorder = defineContainer('wpp-icon-border-v4-2-0', defineWppIconBorder, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconBorderAll = defineContainer('wpp-icon-border-all-v4-2-0', defineWppIconBorderAll, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBorderBottomDouble = defineContainer('wpp-icon-border-bottom-double-v4-2-0', defineWppIconBorderBottomDouble, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBorderLeftRight = defineContainer('wpp-icon-border-left-right-v4-2-0', defineWppIconBorderLeftRight, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBorderNone = defineContainer('wpp-icon-border-none-v4-2-0', defineWppIconBorderNone, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBorderOutside = defineContainer('wpp-icon-border-outside-v4-2-0', defineWppIconBorderOutside, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBorderOutsideThick = defineContainer('wpp-icon-border-outside-thick-v4-2-0', defineWppIconBorderOutsideThick, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBorderTopBottom = defineContainer('wpp-icon-border-top-bottom-v4-2-0', defineWppIconBorderTopBottom, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBorderTopBottomDouble = defineContainer('wpp-icon-border-top-bottom-double-v4-2-0', defineWppIconBorderTopBottomDouble, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBorderTopBottomThick = defineContainer('wpp-icon-border-top-bottom-thick-v4-2-0', defineWppIconBorderTopBottomThick, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBot = defineContainer('wpp-icon-bot-v4-2-0', defineWppIconBot, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBounce = defineContainer('wpp-icon-bounce-v4-2-0', defineWppIconBounce, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBranch = defineContainer('wpp-icon-branch-v4-2-0', defineWppIconBranch, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBranchRequest = defineContainer('wpp-icon-branch-request-v4-2-0', defineWppIconBranchRequest, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBranchReview = defineContainer('wpp-icon-branch-review-v4-2-0', defineWppIconBranchReview, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBtc = defineContainer('wpp-icon-btc-v4-2-0', defineWppIconBtc, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBus = defineContainer('wpp-icon-bus-v4-2-0', defineWppIconBus, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBusiness = defineContainer('wpp-icon-business-v4-2-0', defineWppIconBusiness, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCafe = defineContainer('wpp-icon-cafe-v4-2-0', defineWppIconCafe, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCalendar = defineContainer('wpp-icon-calendar-v4-2-0', defineWppIconCalendar, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCalendar3Days = defineContainer('wpp-icon-calendar-3-days-v4-2-0', defineWppIconCalendar3Days, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCalendarAdd = defineContainer('wpp-icon-calendar-add-v4-2-0', defineWppIconCalendarAdd, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCalendarDate = defineContainer('wpp-icon-calendar-date-v4-2-0', defineWppIconCalendarDate, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCalendarDismiss = defineContainer('wpp-icon-calendar-dismiss-v4-2-0', defineWppIconCalendarDismiss, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCalendarError = defineContainer('wpp-icon-calendar-error-v4-2-0', defineWppIconCalendarError, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCalendarMonth = defineContainer('wpp-icon-calendar-month-v4-2-0', defineWppIconCalendarMonth, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCameraAdd = defineContainer('wpp-icon-camera-add-v4-2-0', defineWppIconCameraAdd, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCameraOff = defineContainer('wpp-icon-camera-off-v4-2-0', defineWppIconCameraOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCameraOn = defineContainer('wpp-icon-camera-on-v4-2-0', defineWppIconCameraOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCameraSwitch = defineContainer('wpp-icon-camera-switch-v4-2-0', defineWppIconCameraSwitch, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCampaign = defineContainer('wpp-icon-campaign-v4-2-0', defineWppIconCampaign, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCaptionOff = defineContainer('wpp-icon-caption-off-v4-2-0', defineWppIconCaptionOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCaptionOn = defineContainer('wpp-icon-caption-on-v4-2-0', defineWppIconCaptionOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCarousel = defineContainer('wpp-icon-carousel-v4-2-0', defineWppIconCarousel, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCart = defineContainer('wpp-icon-cart-v4-2-0', defineWppIconCart, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCase = defineContainer('wpp-icon-case-v4-2-0', defineWppIconCase, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCast = defineContainer('wpp-icon-cast-v4-2-0', defineWppIconCast, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCellularData3g = defineContainer('wpp-icon-cellular-data-3g-v4-2-0', defineWppIconCellularData3g, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCellularData4g = defineContainer('wpp-icon-cellular-data-4g-v4-2-0', defineWppIconCellularData4g, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCellularData5g = defineContainer('wpp-icon-cellular-data-5g-v4-2-0', defineWppIconCellularData5g, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCellularDataOff = defineContainer('wpp-icon-cellular-data-off-v4-2-0', defineWppIconCellularDataOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCellularDataOn = defineContainer('wpp-icon-cellular-data-on-v4-2-0', defineWppIconCellularDataOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconChannel = defineContainer('wpp-icon-channel-v4-2-0', defineWppIconChannel, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconChatMessage = defineContainer('wpp-icon-chat-message-v4-2-0', defineWppIconChatMessage, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconChatMessageNew = defineContainer('wpp-icon-chat-message-new-v4-2-0', defineWppIconChatMessageNew, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconChatMessageOff = defineContainer('wpp-icon-chat-message-off-v4-2-0', defineWppIconChatMessageOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconChatVideo = defineContainer('wpp-icon-chat-video-v4-2-0', defineWppIconChatVideo, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconChevron = defineContainer('wpp-icon-chevron-v4-2-0', defineWppIconChevron, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconCinema = defineContainer('wpp-icon-cinema-v4-2-0', defineWppIconCinema, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCircle = defineContainer('wpp-icon-circle-v4-2-0', defineWppIconCircle, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconClock = defineContainer('wpp-icon-clock-v4-2-0', defineWppIconClock, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconClose = defineContainer('wpp-icon-close-v4-2-0', defineWppIconClose, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCloudDismiss = defineContainer('wpp-icon-cloud-dismiss-v4-2-0', defineWppIconCloudDismiss, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCloudSuccess = defineContainer('wpp-icon-cloud-success-v4-2-0', defineWppIconCloudSuccess, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCloudSync = defineContainer('wpp-icon-cloud-sync-v4-2-0', defineWppIconCloudSync, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCloudUpload = defineContainer('wpp-icon-cloud-upload-v4-2-0', defineWppIconCloudUpload, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCodeView = defineContainer('wpp-icon-code-view-v4-2-0', defineWppIconCodeView, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCollapse = defineContainer('wpp-icon-collapse-v4-2-0', defineWppIconCollapse, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCollection = defineContainer('wpp-icon-collection-v4-2-0', defineWppIconCollection, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconColour = defineContainer('wpp-icon-colour-v4-2-0', defineWppIconColour, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconColumnsOne = defineContainer('wpp-icon-columns-one-v4-2-0', defineWppIconColumnsOne, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconColumnsThree = defineContainer('wpp-icon-columns-three-v4-2-0', defineWppIconColumnsThree, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconColumnsTwo = defineContainer('wpp-icon-columns-two-v4-2-0', defineWppIconColumnsTwo, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconComment = defineContainer('wpp-icon-comment-v4-2-0', defineWppIconComment, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCommentOff = defineContainer('wpp-icon-comment-off-v4-2-0', defineWppIconCommentOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCommunication = defineContainer('wpp-icon-communication-v4-2-0', defineWppIconCommunication, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCompose = defineContainer('wpp-icon-compose-v4-2-0', defineWppIconCompose, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCookies = defineContainer('wpp-icon-cookies-v4-2-0', defineWppIconCookies, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCopy = defineContainer('wpp-icon-copy-v4-2-0', defineWppIconCopy, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCrop = defineContainer('wpp-icon-crop-v4-2-0', defineWppIconCrop, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCross = defineContainer('wpp-icon-cross-v4-2-0', defineWppIconCross, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCta = defineContainer('wpp-icon-cta-v4-2-0', defineWppIconCta, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCube = defineContainer('wpp-icon-cube-v4-2-0', defineWppIconCube, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCurrency = defineContainer('wpp-icon-currency-v4-2-0', defineWppIconCurrency, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCut = defineContainer('wpp-icon-cut-v4-2-0', defineWppIconCut, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDarkTheme = defineContainer('wpp-icon-dark-theme-v4-2-0', defineWppIconDarkTheme, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDash = defineContainer('wpp-icon-dash-v4-2-0', defineWppIconDash, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataArea = defineContainer('wpp-icon-data-area-v4-2-0', defineWppIconDataArea, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataCloudOff = defineContainer('wpp-icon-data-cloud-off-v4-2-0', defineWppIconDataCloudOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataCloudOn = defineContainer('wpp-icon-data-cloud-on-v4-2-0', defineWppIconDataCloudOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataFunnel = defineContainer('wpp-icon-data-funnel-v4-2-0', defineWppIconDataFunnel, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataHistogram = defineContainer('wpp-icon-data-histogram-v4-2-0', defineWppIconDataHistogram, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataLine = defineContainer('wpp-icon-data-line-v4-2-0', defineWppIconDataLine, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataScatter = defineContainer('wpp-icon-data-scatter-v4-2-0', defineWppIconDataScatter, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataSunburst = defineContainer('wpp-icon-data-sunburst-v4-2-0', defineWppIconDataSunburst, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataTransfer = defineContainer('wpp-icon-data-transfer-v4-2-0', defineWppIconDataTransfer, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataTreemap = defineContainer('wpp-icon-data-treemap-v4-2-0', defineWppIconDataTreemap, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataTrending = defineContainer('wpp-icon-data-trending-v4-2-0', defineWppIconDataTrending, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataUsage = defineContainer('wpp-icon-data-usage-v4-2-0', defineWppIconDataUsage, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataViewCards = defineContainer('wpp-icon-data-view-cards-v4-2-0', defineWppIconDataViewCards, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataViewList = defineContainer('wpp-icon-data-view-list-v4-2-0', defineWppIconDataViewList, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataWaterfall = defineContainer('wpp-icon-data-waterfall-v4-2-0', defineWppIconDataWaterfall, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataWhisker = defineContainer('wpp-icon-data-whisker-v4-2-0', defineWppIconDataWhisker, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDatabase = defineContainer('wpp-icon-database-v4-2-0', defineWppIconDatabase, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDecrease = defineContainer('wpp-icon-decrease-v4-2-0', defineWppIconDecrease, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDesign = defineContainer('wpp-icon-design-v4-2-0', defineWppIconDesign, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDesktop = defineContainer('wpp-icon-desktop-v4-2-0', defineWppIconDesktop, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDiamond = defineContainer('wpp-icon-diamond-v4-2-0', defineWppIconDiamond, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDirections = defineContainer('wpp-icon-directions-v4-2-0', defineWppIconDirections, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconDiversity = defineContainer('wpp-icon-diversity-v4-2-0', defineWppIconDiversity, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDocument = defineContainer('wpp-icon-document-v4-2-0', defineWppIconDocument, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDocumentBlocked = defineContainer('wpp-icon-document-blocked-v4-2-0', defineWppIconDocumentBlocked, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDocumentError = defineContainer('wpp-icon-document-error-v4-2-0', defineWppIconDocumentError, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDollar = defineContainer('wpp-icon-dollar-v4-2-0', defineWppIconDollar, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDone = defineContainer('wpp-icon-done-v4-2-0', defineWppIconDone, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDoubleChevron = defineContainer('wpp-icon-double-chevron-v4-2-0', defineWppIconDoubleChevron, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconDownload = defineContainer('wpp-icon-download-v4-2-0', defineWppIconDownload, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDraft = defineContainer('wpp-icon-draft-v4-2-0', defineWppIconDraft, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDrag = defineContainer('wpp-icon-drag-v4-2-0', defineWppIconDrag, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDragAndDrop = defineContainer('wpp-icon-drag-and-drop-v4-2-0', defineWppIconDragAndDrop, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEco = defineContainer('wpp-icon-eco-v4-2-0', defineWppIconEco, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEdit = defineContainer('wpp-icon-edit-v4-2-0', defineWppIconEdit, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEditText = defineContainer('wpp-icon-edit-text-v4-2-0', defineWppIconEditText, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEditorLowercase = defineContainer('wpp-icon-editor-lowercase-v4-2-0', defineWppIconEditorLowercase, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEditorObjectAlignmentCenter = defineContainer('wpp-icon-editor-object-alignment-center-v4-2-0', defineWppIconEditorObjectAlignmentCenter, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEditorTitle = defineContainer('wpp-icon-editor-title-v4-2-0', defineWppIconEditorTitle, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEditorUppercase = defineContainer('wpp-icon-editor-uppercase-v4-2-0', defineWppIconEditorUppercase, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEffects = defineContainer('wpp-icon-effects-v4-2-0', defineWppIconEffects, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEnlarge = defineContainer('wpp-icon-enlarge-v4-2-0', defineWppIconEnlarge, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEnter = defineContainer('wpp-icon-enter-v4-2-0', defineWppIconEnter, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEraser = defineContainer('wpp-icon-eraser-v4-2-0', defineWppIconEraser, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconError = defineContainer('wpp-icon-error-v4-2-0', defineWppIconError, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEth = defineContainer('wpp-icon-eth-v4-2-0', defineWppIconEth, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEuro = defineContainer('wpp-icon-euro-v4-2-0', defineWppIconEuro, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEvent = defineContainer('wpp-icon-event-v4-2-0', defineWppIconEvent, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconExpand = defineContainer('wpp-icon-expand-v4-2-0', defineWppIconExpand, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconExperiment = defineContainer('wpp-icon-experiment-v4-2-0', defineWppIconExperiment, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconExport = defineContainer('wpp-icon-export-v4-2-0', defineWppIconExport, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconExportFile = defineContainer('wpp-icon-export-file-v4-2-0', defineWppIconExportFile, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconExtension = defineContainer('wpp-icon-extension-v4-2-0', defineWppIconExtension, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconExternalLink = defineContainer('wpp-icon-external-link-v4-2-0', defineWppIconExternalLink, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEyeOff = defineContainer('wpp-icon-eye-off-v4-2-0', defineWppIconEyeOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEyeOn = defineContainer('wpp-icon-eye-on-v4-2-0', defineWppIconEyeOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEyedropper = defineContainer('wpp-icon-eyedropper-v4-2-0', defineWppIconEyedropper, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFactory = defineContainer('wpp-icon-factory-v4-2-0', defineWppIconFactory, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFavourites = defineContainer('wpp-icon-favourites-v4-2-0', defineWppIconFavourites, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFavouritesFilled = defineContainer('wpp-icon-favourites-filled-v4-2-0', defineWppIconFavouritesFilled, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFile = defineContainer('wpp-icon-file-v4-2-0', defineWppIconFile, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFileCss = defineContainer('wpp-icon-file-css-v4-2-0', defineWppIconFileCss, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFileJs = defineContainer('wpp-icon-file-js-v4-2-0', defineWppIconFileJs, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFilePdf = defineContainer('wpp-icon-file-pdf-v4-2-0', defineWppIconFilePdf, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFileZip = defineContainer('wpp-icon-file-zip-v4-2-0', defineWppIconFileZip, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFill = defineContainer('wpp-icon-fill-v4-2-0', defineWppIconFill, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFilter = defineContainer('wpp-icon-filter-v4-2-0', defineWppIconFilter, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFingerprint = defineContainer('wpp-icon-fingerprint-v4-2-0', defineWppIconFingerprint, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFitHeight = defineContainer('wpp-icon-fit-height-v4-2-0', defineWppIconFitHeight, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFitWidth = defineContainer('wpp-icon-fit-width-v4-2-0', defineWppIconFitWidth, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFlagOff = defineContainer('wpp-icon-flag-off-v4-2-0', defineWppIconFlagOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFlagOn = defineContainer('wpp-icon-flag-on-v4-2-0', defineWppIconFlagOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFlip = defineContainer('wpp-icon-flip-v4-2-0', defineWppIconFlip, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconFloatCenter = defineContainer('wpp-icon-float-center-v4-2-0', defineWppIconFloatCenter, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFloatLeft = defineContainer('wpp-icon-float-left-v4-2-0', defineWppIconFloatLeft, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFloatRight = defineContainer('wpp-icon-float-right-v4-2-0', defineWppIconFloatRight, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFluidWorkflow = defineContainer('wpp-icon-fluid-workflow-v4-2-0', defineWppIconFluidWorkflow, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFolder = defineContainer('wpp-icon-folder-v4-2-0', defineWppIconFolder, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFolderBlocked = defineContainer('wpp-icon-folder-blocked-v4-2-0', defineWppIconFolderBlocked, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFolderLink = defineContainer('wpp-icon-folder-link-v4-2-0', defineWppIconFolderLink, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFolderOpen = defineContainer('wpp-icon-folder-open-v4-2-0', defineWppIconFolderOpen, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFont = defineContainer('wpp-icon-font-v4-2-0', defineWppIconFont, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconForward = defineContainer('wpp-icon-forward-v4-2-0', defineWppIconForward, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFullscreen = defineContainer('wpp-icon-fullscreen-v4-2-0', defineWppIconFullscreen, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFullscreenMinimise = defineContainer('wpp-icon-fullscreen-minimise-v4-2-0', defineWppIconFullscreenMinimise, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconGallery = defineContainer('wpp-icon-gallery-v4-2-0', defineWppIconGallery, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconGasStation = defineContainer('wpp-icon-gas-station-v4-2-0', defineWppIconGasStation, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconGear = defineContainer('wpp-icon-gear-v4-2-0', defineWppIconGear, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconGif = defineContainer('wpp-icon-gif-v4-2-0', defineWppIconGif, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconGlobe = defineContainer('wpp-icon-globe-v4-2-0', defineWppIconGlobe, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconGps = defineContainer('wpp-icon-gps-v4-2-0', defineWppIconGps, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconGraph = defineContainer('wpp-icon-graph-v4-2-0', defineWppIconGraph, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconGrid = defineContainer('wpp-icon-grid-v4-2-0', defineWppIconGrid, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconH1 = defineContainer('wpp-icon-h1-v4-2-0', defineWppIconH1, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconH2 = defineContainer('wpp-icon-h2-v4-2-0', defineWppIconH2, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconH3 = defineContainer('wpp-icon-h3-v4-2-0', defineWppIconH3, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHandDraw = defineContainer('wpp-icon-hand-draw-v4-2-0', defineWppIconHandDraw, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHandOff = defineContainer('wpp-icon-hand-off-v4-2-0', defineWppIconHandOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHandOn = defineContainer('wpp-icon-hand-on-v4-2-0', defineWppIconHandOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHash = defineContainer('wpp-icon-hash-v4-2-0', defineWppIconHash, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHd = defineContainer('wpp-icon-hd-v4-2-0', defineWppIconHd, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHdr = defineContainer('wpp-icon-hdr-v4-2-0', defineWppIconHdr, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHeadphones = defineContainer('wpp-icon-headphones-v4-2-0', defineWppIconHeadphones, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHelp = defineContainer('wpp-icon-help-v4-2-0', defineWppIconHelp, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconHistory = defineContainer('wpp-icon-history-v4-2-0', defineWppIconHistory, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHome = defineContainer('wpp-icon-home-v4-2-0', defineWppIconHome, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHomeCheckmark = defineContainer('wpp-icon-home-checkmark-v4-2-0', defineWppIconHomeCheckmark, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHospital = defineContainer('wpp-icon-hospital-v4-2-0', defineWppIconHospital, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHub = defineContainer('wpp-icon-hub-v4-2-0', defineWppIconHub, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconIcons = defineContainer('wpp-icon-icons-v4-2-0', defineWppIconIcons, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconIdea = defineContainer('wpp-icon-idea-v4-2-0', defineWppIconIdea, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconIframe = defineContainer('wpp-icon-iframe-v4-2-0', defineWppIconIframe, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconImage = defineContainer('wpp-icon-image-v4-2-0', defineWppIconImage, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconImageOff = defineContainer('wpp-icon-image-off-v4-2-0', defineWppIconImageOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconImport = defineContainer('wpp-icon-import-v4-2-0', defineWppIconImport, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconInbox = defineContainer('wpp-icon-inbox-v4-2-0', defineWppIconInbox, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconIncognito = defineContainer('wpp-icon-incognito-v4-2-0', defineWppIconIncognito, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconIncomplete = defineContainer('wpp-icon-incomplete-v4-2-0', defineWppIconIncomplete, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconIncrease = defineContainer('wpp-icon-increase-v4-2-0', defineWppIconIncrease, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconIndentDecrease = defineContainer('wpp-icon-indent-decrease-v4-2-0', defineWppIconIndentDecrease, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconIndentIncrease = defineContainer('wpp-icon-indent-increase-v4-2-0', defineWppIconIndentIncrease, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconInfo = defineContainer('wpp-icon-info-v4-2-0', defineWppIconInfo, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconInfoMessage = defineContainer('wpp-icon-info-message-v4-2-0', defineWppIconInfoMessage, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconInstallUpdate = defineContainer('wpp-icon-install-update-v4-2-0', defineWppIconInstallUpdate, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconItalic = defineContainer('wpp-icon-italic-v4-2-0', defineWppIconItalic, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconJavaScript = defineContainer('wpp-icon-java-script-v4-2-0', defineWppIconJavaScript, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconJoin = defineContainer('wpp-icon-join-v4-2-0', defineWppIconJoin, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconKey = defineContainer('wpp-icon-key-v4-2-0', defineWppIconKey, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconKeyboard = defineContainer('wpp-icon-keyboard-v4-2-0', defineWppIconKeyboard, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLaptop = defineContainer('wpp-icon-laptop-v4-2-0', defineWppIconLaptop, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLaugh = defineContainer('wpp-icon-laugh-v4-2-0', defineWppIconLaugh, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLaunch = defineContainer('wpp-icon-launch-v4-2-0', defineWppIconLaunch, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLayer = defineContainer('wpp-icon-layer-v4-2-0', defineWppIconLayer, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLeaf = defineContainer('wpp-icon-leaf-v4-2-0', defineWppIconLeaf, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLibrary = defineContainer('wpp-icon-library-v4-2-0', defineWppIconLibrary, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLibraryBuilding = defineContainer('wpp-icon-library-building-v4-2-0', defineWppIconLibraryBuilding, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLikeOff = defineContainer('wpp-icon-like-off-v4-2-0', defineWppIconLikeOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLikeOn = defineContainer('wpp-icon-like-on-v4-2-0', defineWppIconLikeOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLink = defineContainer('wpp-icon-link-v4-2-0', defineWppIconLink, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLive = defineContainer('wpp-icon-live-v4-2-0', defineWppIconLive, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLocation = defineContainer('wpp-icon-location-v4-2-0', defineWppIconLocation, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLockOff = defineContainer('wpp-icon-lock-off-v4-2-0', defineWppIconLockOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLockOn = defineContainer('wpp-icon-lock-on-v4-2-0', defineWppIconLockOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLodging = defineContainer('wpp-icon-lodging-v4-2-0', defineWppIconLodging, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLogin = defineContainer('wpp-icon-login-v4-2-0', defineWppIconLogin, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLogout = defineContainer('wpp-icon-logout-v4-2-0', defineWppIconLogout, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMagicWand = defineContainer('wpp-icon-magic-wand-v4-2-0', defineWppIconMagicWand, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMail = defineContainer('wpp-icon-mail-v4-2-0', defineWppIconMail, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMailAdd = defineContainer('wpp-icon-mail-add-v4-2-0', defineWppIconMailAdd, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMailAllRead = defineContainer('wpp-icon-mail-all-read-v4-2-0', defineWppIconMailAllRead, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMailBlocked = defineContainer('wpp-icon-mail-blocked-v4-2-0', defineWppIconMailBlocked, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMailCopy = defineContainer('wpp-icon-mail-copy-v4-2-0', defineWppIconMailCopy, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMailOff = defineContainer('wpp-icon-mail-off-v4-2-0', defineWppIconMailOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMailRead = defineContainer('wpp-icon-mail-read-v4-2-0', defineWppIconMailRead, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMap = defineContainer('wpp-icon-map-v4-2-0', defineWppIconMap, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMathFormula = defineContainer('wpp-icon-math-formula-v4-2-0', defineWppIconMathFormula, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMaximise = defineContainer('wpp-icon-maximise-v4-2-0', defineWppIconMaximise, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconMeet = defineContainer('wpp-icon-meet-v4-2-0', defineWppIconMeet, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMention = defineContainer('wpp-icon-mention-v4-2-0', defineWppIconMention, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMerge = defineContainer('wpp-icon-merge-v4-2-0', defineWppIconMerge, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconMicBlocked = defineContainer('wpp-icon-mic-blocked-v4-2-0', defineWppIconMicBlocked, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMicOff = defineContainer('wpp-icon-mic-off-v4-2-0', defineWppIconMicOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMicOn = defineContainer('wpp-icon-mic-on-v4-2-0', defineWppIconMicOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMinimise = defineContainer('wpp-icon-minimise-v4-2-0', defineWppIconMinimise, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconMobile = defineContainer('wpp-icon-mobile-v4-2-0', defineWppIconMobile, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMoney = defineContainer('wpp-icon-money-v4-2-0', defineWppIconMoney, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMore = defineContainer('wpp-icon-more-v4-2-0', defineWppIconMore, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconMove = defineContainer('wpp-icon-move-v4-2-0', defineWppIconMove, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMovie = defineContainer('wpp-icon-movie-v4-2-0', defineWppIconMovie, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMultipleEmotions = defineContainer('wpp-icon-multiple-emotions-v4-2-0', defineWppIconMultipleEmotions, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMusic = defineContainer('wpp-icon-music-v4-2-0', defineWppIconMusic, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNavigationMenu = defineContainer('wpp-icon-navigation-menu-v4-2-0', defineWppIconNavigationMenu, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNeutral = defineContainer('wpp-icon-neutral-v4-2-0', defineWppIconNeutral, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNeutralTrading = defineContainer('wpp-icon-neutral-trading-v4-2-0', defineWppIconNeutralTrading, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNewspaper = defineContainer('wpp-icon-newspaper-v4-2-0', defineWppIconNewspaper, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNext = defineContainer('wpp-icon-next-v4-2-0', defineWppIconNext, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNightLife = defineContainer('wpp-icon-night-life-v4-2-0', defineWppIconNightLife, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNote = defineContainer('wpp-icon-note-v4-2-0', defineWppIconNote, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNotificationNew = defineContainer('wpp-icon-notification-new-v4-2-0', defineWppIconNotificationNew, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNotificationOff = defineContainer('wpp-icon-notification-off-v4-2-0', defineWppIconNotificationOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNotificationOn = defineContainer('wpp-icon-notification-on-v4-2-0', defineWppIconNotificationOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNotificationPause = defineContainer('wpp-icon-notification-pause-v4-2-0', defineWppIconNotificationPause, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNuclearDanger = defineContainer('wpp-icon-nuclear-danger-v4-2-0', defineWppIconNuclearDanger, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNumber = defineContainer('wpp-icon-number-v4-2-0', defineWppIconNumber, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconObjectAlignment = defineContainer('wpp-icon-object-alignment-v4-2-0', defineWppIconObjectAlignment, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconObjectAlignmentCenter = defineContainer('wpp-icon-object-alignment-center-v4-2-0', defineWppIconObjectAlignmentCenter, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconOrderedList = defineContainer('wpp-icon-ordered-list-v4-2-0', defineWppIconOrderedList, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconOrganization = defineContainer('wpp-icon-organization-v4-2-0', defineWppIconOrganization, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconOrientation = defineContainer('wpp-icon-orientation-v4-2-0', defineWppIconOrientation, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconOutdoor = defineContainer('wpp-icon-outdoor-v4-2-0', defineWppIconOutdoor, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconOutdoorMedia = defineContainer('wpp-icon-outdoor-media-v4-2-0', defineWppIconOutdoorMedia, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconOwner = defineContainer('wpp-icon-owner-v4-2-0', defineWppIconOwner, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPadding = defineContainer('wpp-icon-padding-v4-2-0', defineWppIconPadding, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconPair = defineContainer('wpp-icon-pair-v4-2-0', defineWppIconPair, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconParking = defineContainer('wpp-icon-parking-v4-2-0', defineWppIconParking, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPaste = defineContainer('wpp-icon-paste-v4-2-0', defineWppIconPaste, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPause = defineContainer('wpp-icon-pause-v4-2-0', defineWppIconPause, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPen = defineContainer('wpp-icon-pen-v4-2-0', defineWppIconPen, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPending = defineContainer('wpp-icon-pending-v4-2-0', defineWppIconPending, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPentagon = defineContainer('wpp-icon-pentagon-v4-2-0', defineWppIconPentagon, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPeople = defineContainer('wpp-icon-people-v4-2-0', defineWppIconPeople, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPharmacy = defineContainer('wpp-icon-pharmacy-v4-2-0', defineWppIconPharmacy, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPhone = defineContainer('wpp-icon-phone-v4-2-0', defineWppIconPhone, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPieChart = defineContainer('wpp-icon-pie-chart-v4-2-0', defineWppIconPieChart, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPinned = defineContainer('wpp-icon-pinned-v4-2-0', defineWppIconPinned, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPitch = defineContainer('wpp-icon-pitch-v4-2-0', defineWppIconPitch, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPlay = defineContainer('wpp-icon-play-v4-2-0', defineWppIconPlay, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPlayerStop = defineContainer('wpp-icon-player-stop-v4-2-0', defineWppIconPlayerStop, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPlus = defineContainer('wpp-icon-plus-v4-2-0', defineWppIconPlus, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPlusCircle = defineContainer('wpp-icon-plus-circle-v4-2-0', defineWppIconPlusCircle, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPolice = defineContainer('wpp-icon-police-v4-2-0', defineWppIconPolice, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPost = defineContainer('wpp-icon-post-v4-2-0', defineWppIconPost, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPound = defineContainer('wpp-icon-pound-v4-2-0', defineWppIconPound, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPremium = defineContainer('wpp-icon-premium-v4-2-0', defineWppIconPremium, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPrevious = defineContainer('wpp-icon-previous-v4-2-0', defineWppIconPrevious, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPrint = defineContainer('wpp-icon-print-v4-2-0', defineWppIconPrint, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPrivateAccount = defineContainer('wpp-icon-private-account-v4-2-0', defineWppIconPrivateAccount, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconQa = defineContainer('wpp-icon-qa-v4-2-0', defineWppIconQa, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconQrCode = defineContainer('wpp-icon-qr-code-v4-2-0', defineWppIconQrCode, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRadio = defineContainer('wpp-icon-radio-v4-2-0', defineWppIconRadio, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRanking = defineContainer('wpp-icon-ranking-v4-2-0', defineWppIconRanking, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRatio = defineContainer('wpp-icon-ratio-v4-2-0', defineWppIconRatio, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRecord = defineContainer('wpp-icon-record-v4-2-0', defineWppIconRecord, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRecordStop = defineContainer('wpp-icon-record-stop-v4-2-0', defineWppIconRecordStop, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRectangle = defineContainer('wpp-icon-rectangle-v4-2-0', defineWppIconRectangle, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRecycle = defineContainer('wpp-icon-recycle-v4-2-0', defineWppIconRecycle, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRedo = defineContainer('wpp-icon-redo-v4-2-0', defineWppIconRedo, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRefresh = defineContainer('wpp-icon-refresh-v4-2-0', defineWppIconRefresh, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRefreshDashed = defineContainer('wpp-icon-refresh-dashed-v4-2-0', defineWppIconRefreshDashed, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconReject = defineContainer('wpp-icon-reject-v4-2-0', defineWppIconReject, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRemove = defineContainer('wpp-icon-remove-v4-2-0', defineWppIconRemove, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRemoveApp = defineContainer('wpp-icon-remove-app-v4-2-0', defineWppIconRemoveApp, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRemoveCircle = defineContainer('wpp-icon-remove-circle-v4-2-0', defineWppIconRemoveCircle, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRepeatOff = defineContainer('wpp-icon-repeat-off-v4-2-0', defineWppIconRepeatOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRepeatOn = defineContainer('wpp-icon-repeat-on-v4-2-0', defineWppIconRepeatOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconReply = defineContainer('wpp-icon-reply-v4-2-0', defineWppIconReply, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconReplyAll = defineContainer('wpp-icon-reply-all-v4-2-0', defineWppIconReplyAll, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconReset = defineContainer('wpp-icon-reset-v4-2-0', defineWppIconReset, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconResetDashed = defineContainer('wpp-icon-reset-dashed-v4-2-0', defineWppIconResetDashed, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconResize = defineContainer('wpp-icon-resize-v4-2-0', defineWppIconResize, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconResizeLarge = defineContainer('wpp-icon-resize-large-v4-2-0', defineWppIconResizeLarge, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconResizeSmall = defineContainer('wpp-icon-resize-small-v4-2-0', defineWppIconResizeSmall, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRestaurant = defineContainer('wpp-icon-restaurant-v4-2-0', defineWppIconRestaurant, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRhombus = defineContainer('wpp-icon-rhombus-v4-2-0', defineWppIconRhombus, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRotate = defineContainer('wpp-icon-rotate-v4-2-0', defineWppIconRotate, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconRotateClockwise = defineContainer('wpp-icon-rotate-clockwise-v4-2-0', defineWppIconRotateClockwise, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRotateCounterclockwise = defineContainer('wpp-icon-rotate-counterclockwise-v4-2-0', defineWppIconRotateCounterclockwise, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRss = defineContainer('wpp-icon-rss-v4-2-0', defineWppIconRss, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRupee = defineContainer('wpp-icon-rupee-v4-2-0', defineWppIconRupee, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSad = defineContainer('wpp-icon-sad-v4-2-0', defineWppIconSad, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSadSlightly = defineContainer('wpp-icon-sad-slightly-v4-2-0', defineWppIconSadSlightly, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconScale = defineContainer('wpp-icon-scale-v4-2-0', defineWppIconScale, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconScaleBottom = defineContainer('wpp-icon-scale-bottom-v4-2-0', defineWppIconScaleBottom, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconScan = defineContainer('wpp-icon-scan-v4-2-0', defineWppIconScan, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSchool = defineContainer('wpp-icon-school-v4-2-0', defineWppIconSchool, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSearch = defineContainer('wpp-icon-search-v4-2-0', defineWppIconSearch, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSegmentedControl = defineContainer('wpp-icon-segmented-control-v4-2-0', defineWppIconSegmentedControl, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSelectObject = defineContainer('wpp-icon-select-object-v4-2-0', defineWppIconSelectObject, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSend = defineContainer('wpp-icon-send-v4-2-0', defineWppIconSend, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSendOff = defineContainer('wpp-icon-send-off-v4-2-0', defineWppIconSendOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconService = defineContainer('wpp-icon-service-v4-2-0', defineWppIconService, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconShapes = defineContainer('wpp-icon-shapes-v4-2-0', defineWppIconShapes, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconShare = defineContainer('wpp-icon-share-v4-2-0', defineWppIconShare, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconShield = defineContainer('wpp-icon-shield-v4-2-0', defineWppIconShield, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconShieldDismiss = defineContainer('wpp-icon-shield-dismiss-v4-2-0', defineWppIconShieldDismiss, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconShieldError = defineContainer('wpp-icon-shield-error-v4-2-0', defineWppIconShieldError, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconShieldSuccess = defineContainer('wpp-icon-shield-success-v4-2-0', defineWppIconShieldSuccess, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconShip = defineContainer('wpp-icon-ship-v4-2-0', defineWppIconShip, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconShopping = defineContainer('wpp-icon-shopping-v4-2-0', defineWppIconShopping, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconShutDown = defineContainer('wpp-icon-shut-down-v4-2-0', defineWppIconShutDown, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSmartwatch = defineContainer('wpp-icon-smartwatch-v4-2-0', defineWppIconSmartwatch, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSmile = defineContainer('wpp-icon-smile-v4-2-0', defineWppIconSmile, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSmileSlightly = defineContainer('wpp-icon-smile-slightly-v4-2-0', defineWppIconSmileSlightly, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSocialMedia = defineContainer('wpp-icon-social-media-v4-2-0', defineWppIconSocialMedia, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSort = defineContainer('wpp-icon-sort-v4-2-0', defineWppIconSort, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSortDecrease = defineContainer('wpp-icon-sort-decrease-v4-2-0', defineWppIconSortDecrease, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSortIncrease = defineContainer('wpp-icon-sort-increase-v4-2-0', defineWppIconSortIncrease, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSparkle = defineContainer('wpp-icon-sparkle-v4-2-0', defineWppIconSparkle, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSpeaker = defineContainer('wpp-icon-speaker-v4-2-0', defineWppIconSpeaker, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSpeakerBluetooth = defineContainer('wpp-icon-speaker-bluetooth-v4-2-0', defineWppIconSpeakerBluetooth, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSpeakerMute = defineContainer('wpp-icon-speaker-mute-v4-2-0', defineWppIconSpeakerMute, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSpeakerOff = defineContainer('wpp-icon-speaker-off-v4-2-0', defineWppIconSpeakerOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSplit = defineContainer('wpp-icon-split-v4-2-0', defineWppIconSplit, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconSport = defineContainer('wpp-icon-sport-v4-2-0', defineWppIconSport, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSpreadsheet = defineContainer('wpp-icon-spreadsheet-v4-2-0', defineWppIconSpreadsheet, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSquare = defineContainer('wpp-icon-square-v4-2-0', defineWppIconSquare, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSquareHint = defineContainer('wpp-icon-square-hint-v4-2-0', defineWppIconSquareHint, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconStatisticDocument = defineContainer('wpp-icon-statistic-document-v4-2-0', defineWppIconStatisticDocument, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSticker = defineContainer('wpp-icon-sticker-v4-2-0', defineWppIconSticker, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconStop = defineContainer('wpp-icon-stop-v4-2-0', defineWppIconStop, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconStrikeThrough = defineContainer('wpp-icon-strike-through-v4-2-0', defineWppIconStrikeThrough, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconStyleguide = defineContainer('wpp-icon-styleguide-v4-2-0', defineWppIconStyleguide, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSubItems = defineContainer('wpp-icon-sub-items-v4-2-0', defineWppIconSubItems, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSubscribe = defineContainer('wpp-icon-subscribe-v4-2-0', defineWppIconSubscribe, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSuccess = defineContainer('wpp-icon-success-v4-2-0', defineWppIconSuccess, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSupermarket = defineContainer('wpp-icon-supermarket-v4-2-0', defineWppIconSupermarket, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSupport = defineContainer('wpp-icon-support-v4-2-0', defineWppIconSupport, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSupportChat = defineContainer('wpp-icon-support-chat-v4-2-0', defineWppIconSupportChat, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSurprise = defineContainer('wpp-icon-surprise-v4-2-0', defineWppIconSurprise, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSymbols = defineContainer('wpp-icon-symbols-v4-2-0', defineWppIconSymbols, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSync = defineContainer('wpp-icon-sync-v4-2-0', defineWppIconSync, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTableDefault = defineContainer('wpp-icon-table-default-v4-2-0', defineWppIconTableDefault, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTableDismiss = defineContainer('wpp-icon-table-dismiss-v4-2-0', defineWppIconTableDismiss, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTableEdit = defineContainer('wpp-icon-table-edit-v4-2-0', defineWppIconTableEdit, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTableLink = defineContainer('wpp-icon-table-link-v4-2-0', defineWppIconTableLink, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTableSimple = defineContainer('wpp-icon-table-simple-v4-2-0', defineWppIconTableSimple, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTableSort = defineContainer('wpp-icon-table-sort-v4-2-0', defineWppIconTableSort, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconTableSortAsc = defineContainer('wpp-icon-table-sort-asc-v4-2-0', defineWppIconTableSortAsc, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconTableSortAscHover = defineContainer('wpp-icon-table-sort-asc-hover-v4-2-0', defineWppIconTableSortAscHover, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconTableSortAscPressed = defineContainer('wpp-icon-table-sort-asc-pressed-v4-2-0', defineWppIconTableSortAscPressed, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconTableSortDesc = defineContainer('wpp-icon-table-sort-desc-v4-2-0', defineWppIconTableSortDesc, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconTableSortDescHover = defineContainer('wpp-icon-table-sort-desc-hover-v4-2-0', defineWppIconTableSortDescHover, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconTableSortDescPressed = defineContainer('wpp-icon-table-sort-desc-pressed-v4-2-0', defineWppIconTableSortDescPressed, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconTableSortHover = defineContainer('wpp-icon-table-sort-hover-v4-2-0', defineWppIconTableSortHover, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconTableSortPressed = defineContainer('wpp-icon-table-sort-pressed-v4-2-0', defineWppIconTableSortPressed, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconTableSortWrapper = defineContainer('wpp-icon-table-sort-wrapper-v4-2-0', defineWppIconTableSortWrapper, [
    'size',
    'width',
    'height',
    'direction',
...
export const WppIconTablet = defineContainer('wpp-icon-tablet-v4-2-0', defineWppIconTablet, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTag = defineContainer('wpp-icon-tag-v4-2-0', defineWppIconTag, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTarget = defineContainer('wpp-icon-target-v4-2-0', defineWppIconTarget, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTaskList = defineContainer('wpp-icon-task-list-v4-2-0', defineWppIconTaskList, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTaskListSquare = defineContainer('wpp-icon-task-list-square-v4-2-0', defineWppIconTaskListSquare, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconText = defineContainer('wpp-icon-text-v4-2-0', defineWppIconText, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTextAlignmentCenter = defineContainer('wpp-icon-text-alignment-center-v4-2-0', defineWppIconTextAlignmentCenter, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTextAlignmentDistribute = defineContainer('wpp-icon-text-alignment-distribute-v4-2-0', defineWppIconTextAlignmentDistribute, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTextAlignmentDistributeVertical = defineContainer('wpp-icon-text-alignment-distribute-vertical-v4-2-0', defineWppIconTextAlignmentDistributeVertical, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTextAlignmentJustify = defineContainer('wpp-icon-text-alignment-justify-v4-2-0', defineWppIconTextAlignmentJustify, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTextAlignmentJustifyLow = defineContainer('wpp-icon-text-alignment-justify-low-v4-2-0', defineWppIconTextAlignmentJustifyLow, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTextAlignmentLeft = defineContainer('wpp-icon-text-alignment-left-v4-2-0', defineWppIconTextAlignmentLeft, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTextAlignmentRight = defineContainer('wpp-icon-text-alignment-right-v4-2-0', defineWppIconTextAlignmentRight, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTheatre = defineContainer('wpp-icon-theatre-v4-2-0', defineWppIconTheatre, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconThumbsDown = defineContainer('wpp-icon-thumbs-down-v4-2-0', defineWppIconThumbsDown, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconThumbsDownFilled = defineContainer('wpp-icon-thumbs-down-filled-v4-2-0', defineWppIconThumbsDownFilled, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconThumbsUp = defineContainer('wpp-icon-thumbs-up-v4-2-0', defineWppIconThumbsUp, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconThumbsUpFilled = defineContainer('wpp-icon-thumbs-up-filled-v4-2-0', defineWppIconThumbsUpFilled, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTick = defineContainer('wpp-icon-tick-v4-2-0', defineWppIconTick, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTourism = defineContainer('wpp-icon-tourism-v4-2-0', defineWppIconTourism, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTrain = defineContainer('wpp-icon-train-v4-2-0', defineWppIconTrain, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTranslate = defineContainer('wpp-icon-translate-v4-2-0', defineWppIconTranslate, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTrash = defineContainer('wpp-icon-trash-v4-2-0', defineWppIconTrash, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTrendAscend = defineContainer('wpp-icon-trend-ascend-v4-2-0', defineWppIconTrendAscend, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTrendDescent = defineContainer('wpp-icon-trend-descent-v4-2-0', defineWppIconTrendDescent, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTriangle = defineContainer('wpp-icon-triangle-v4-2-0', defineWppIconTriangle, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTriangleFill = defineContainer('wpp-icon-triangle-fill-v4-2-0', defineWppIconTriangleFill, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTune = defineContainer('wpp-icon-tune-v4-2-0', defineWppIconTune, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTv = defineContainer('wpp-icon-tv-v4-2-0', defineWppIconTv, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTwentyFourHours = defineContainer('wpp-icon-twenty-four-hours-v4-2-0', defineWppIconTwentyFourHours, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUnderline = defineContainer('wpp-icon-underline-v4-2-0', defineWppIconUnderline, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUndo = defineContainer('wpp-icon-undo-v4-2-0', defineWppIconUndo, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUnlink = defineContainer('wpp-icon-unlink-v4-2-0', defineWppIconUnlink, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUnorderedList = defineContainer('wpp-icon-unordered-list-v4-2-0', defineWppIconUnorderedList, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUnpinned = defineContainer('wpp-icon-unpinned-v4-2-0', defineWppIconUnpinned, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUpload = defineContainer('wpp-icon-upload-v4-2-0', defineWppIconUpload, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUser = defineContainer('wpp-icon-user-v4-2-0', defineWppIconUser, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUserAdd = defineContainer('wpp-icon-user-add-v4-2-0', defineWppIconUserAdd, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUserBlock = defineContainer('wpp-icon-user-block-v4-2-0', defineWppIconUserBlock, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUserChat = defineContainer('wpp-icon-user-chat-v4-2-0', defineWppIconUserChat, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUserSearch = defineContainer('wpp-icon-user-search-v4-2-0', defineWppIconUserSearch, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUserStarred = defineContainer('wpp-icon-user-starred-v4-2-0', defineWppIconUserStarred, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUserTag = defineContainer('wpp-icon-user-tag-v4-2-0', defineWppIconUserTag, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconVideoBlocked = defineContainer('wpp-icon-video-blocked-v4-2-0', defineWppIconVideoBlocked, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconVideoClip = defineContainer('wpp-icon-video-clip-v4-2-0', defineWppIconVideoClip, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconVideoOff = defineContainer('wpp-icon-video-off-v4-2-0', defineWppIconVideoOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconVideoOn = defineContainer('wpp-icon-video-on-v4-2-0', defineWppIconVideoOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconVr = defineContainer('wpp-icon-vr-v4-2-0', defineWppIconVr, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconWarning = defineContainer('wpp-icon-warning-v4-2-0', defineWppIconWarning, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconWifiOff = defineContainer('wpp-icon-wifi-off-v4-2-0', defineWppIconWifiOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconWifiOn = defineContainer('wpp-icon-wifi-on-v4-2-0', defineWppIconWifiOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconWifiWarning = defineContainer('wpp-icon-wifi-warning-v4-2-0', defineWppIconWifiWarning, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconWithHand = defineContainer('wpp-icon-with-hand-v4-2-0', defineWppIconWithHand, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconWorkshop = defineContainer('wpp-icon-workshop-v4-2-0', defineWppIconWorkshop, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconWrapOff = defineContainer('wpp-icon-wrap-off-v4-2-0', defineWppIconWrapOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconWrapOn = defineContainer('wpp-icon-wrap-on-v4-2-0', defineWppIconWrapOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconYen = defineContainer('wpp-icon-yen-v4-2-0', defineWppIconYen, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconYuan = defineContainer('wpp-icon-yuan-v4-2-0', defineWppIconYuan, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconZoo = defineContainer('wpp-icon-zoo-v4-2-0', defineWppIconZoo, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconZoomIn = defineContainer('wpp-icon-zoom-in-v4-2-0', defineWppIconZoomIn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconZoomOut = defineContainer('wpp-icon-zoom-out-v4-2-0', defineWppIconZoomOut, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppInlineEdit = defineContainer('wpp-inline-edit-v4-2-0', defineWppInlineEdit, [
    'mode',
    'value',
    'placeholder',
    'dropdownConfig',
...
export const WppInlineMessage = defineContainer('wpp-inline-message-v4-2-0', defineWppInlineMessage, [
    'titleText',
    'actionBtnText',
    'message',
    'type',
...
export const WppInput = defineContainer('wpp-input-v4-2-0', defineWppInput, [
    'name',
    'type',
    'value',
    'defaultValue',
...
export const WppInternalLabel = defineContainer('wpp-internal-label-v4-2-0', defineWppInternalLabel, [
    'labelText',
    'description',
    'optional',
    'typography',
...
export const WppLabel = defineContainer('wpp-label-v4-2-0', defineWppLabel, [
    'description',
    'htmlFor',
    'optional',
    'typography',
...
export const WppLegacyAutocomplete = defineContainer('wpp-legacy-autocomplete-v4-2-0', defineWppLegacyAutocomplete, [
    'name',
    'loading',
    'disabled',
    'autoFocus',
...
export const WppLegacyAvatar = defineContainer('wpp-legacy-avatar-v4-2-0', defineWppLegacyAvatar, [
    'name',
    'size',
    'variant',
    'src',
...
export const WppLegacyCounter = defineContainer('wpp-legacy-counter-v4-2-0', defineWppLegacyCounter, [
    'name',
    'value',
    'min',
    'max',
...
export const WppLegacyStickyBar = defineContainer('wpp-legacy-sticky-bar-v4-2-0', defineWppLegacyStickyBar, [
    'variant',
    'barTitle',
    'offsetFromTop',
    'zIndex',
...
export const WppLegacyTopbar = defineContainer('wpp-legacy-topbar-v4-2-0', defineWppLegacyTopbar, [
    'navigation',
    'value',
    'nativeLink',
    'zIndex',
...
export const WppLegacyTopbarItem = defineContainer('wpp-legacy-topbar-item-v4-2-0', defineWppLegacyTopbarItem, [
    'navigation',
    'firstLevel',
    'menu',
    'active',
...
export const WppLegend = defineContainer('wpp-legend-v4-2-0', defineWppLegend, [
    'label',
    'disabled',
    'color'
]);
export const WppListItem = defineContainer('wpp-list-item-v4-2-0', defineWppListItem, [
    'labelTypography',
    'captionTypography',
    'value',
    'label',
...
export const WppLoadMore = defineContainer('wpp-load-more-v4-2-0', defineWppLoadMore, [
    'totalItems',
    'itemsLoaded',
    'showProgressBar',
    'loading',
...
export const WppMenuContext = defineContainer('wpp-menu-context-v4-2-0', defineWppMenuContext, [
    'listWidth',
    'dropdownConfig',
    'appendToListWrapper',
    'externalClass',
...
export const WppMenuGroup = defineContainer('wpp-menu-group-v4-2-0', defineWppMenuGroup, [
    'header',
    'withDivider'
]);
export const WppModal = defineContainer('wpp-modal-v4-2-0', defineWppModal, [
    'open',
    'size',
    'withTransparentOverlay',
    'disableOutsideClick',
...
export const WppMoreButton = defineContainer('wpp-more-button-v4-2-0', defineWppMoreButton, [
    'name',
    'size',
    'disabled',
    'loading',
...
export const WppNavSidebar = defineContainer('wpp-nav-sidebar-v4-2-0', defineWppNavSidebar, [
    'activePath',
    'nativeLink',
    'zIndex',
    'wppChange'
]);
export const WppNavSidebarItem = defineContainer('wpp-nav-sidebar-item-v4-2-0', defineWppNavSidebarItem, [
    'expanded',
    'extended',
...
export const WppNavigationItem = defineContainer('wpp-navigation-item-v4-2-0', defineWppNavigationItem, [
    'menuExpanded',
    'label',
    'value',
    'path',
...
export const WppOverlay = defineContainer('wpp-overlay-v4-2-0', defineWppOverlay, [
    'isVisible',
    'zIndex',
    'wppClick'
]);
export const WppPagination = defineContainer('wpp-pagination-v4-2-0', defineWppPagination, [
    'count',
    'itemsPerPage',
    'selectedItemPerPage',
    'pageSelectThreshold',
...
export const WppPaginationItem = defineContainer('wpp-pagination-item-v4-2-0', defineWppPaginationItem, [
    'number',
    'selected',
    'wppPageChange'
]);
export const WppPaginationSelect = defineContainer('wpp-pagination-select-v4-2-0', defineWppPaginationSelect, [
    'count',
    'itemsPerPage',
    'pageSelectThreshold',
    'activePageNumber',
...
export const WppPill = defineContainer('wpp-pill-v4-2-0', defineWppPill, [
    'value',
    'size',
    'type',
    'disabled',
...
export const WppPillGroup = defineContainer('wpp-pill-group-v4-2-0', defineWppPillGroup, [
    'name',
    'size',
    'value',
    'type',
...
export const WppPopover = defineContainer('wpp-popover-v4-2-0', defineWppPopover, [
    'config',
...
export const WppProgressIndicator = defineContainer('wpp-progress-indicator-v4-2-0', defineWppProgressIndicator, [
    'width',
    'variant',
    'value',
    'isShowPercentage',
...
export const WppRadio = defineContainer('wpp-radio-v4-2-0', defineWppRadio, [
    'name',
    'value',
    'checked',
    'required',
...
export const WppRadioGroup = defineContainer('wpp-radio-group-v4-2-0', defineWppRadioGroup, [
    'value',
    'required',
    'message',
    'messageType',
...
export const WppRichtext = defineContainer('wpp-richtext-v4-2-0', defineWppRichtext, [
    'name',
    'required',
    'disabled',
    'autoFocus',
...
export const WppRichtextCommonStyles = defineContainer('wpp-richtext-common-styles-v4-2-0', defineWppRichtextCommonStyles);
export const WppRichtextHtml = defineContainer('wpp-richtext-html-v4-2-0', defineWppRichtextHtml, [
    'value'
]);
export const WppRichtextIconLoader = defineContainer('wpp-richtext-icon-loader-v4-2-0', defineWppRichtextIconLoader);
export const WppRichtextMarkdown = defineContainer('wpp-richtext-markdown-v4-2-0', defineWppRichtextMarkdown, [
    'value'
]);
export const WppRichtextView = defineContainer('wpp-richtext-view-v4-2-0', defineWppRichtextView, [
    'value',
    'format',
    'formats',
    'modules',
...
export const WppSearch = defineContainer('wpp-search-v4-2-0', defineWppSearch, [
    'name',
    'loading',
    'disabled',
    'autoFocus',
...
export const WppSegmentedControl = defineContainer('wpp-segmented-control-v4-2-0', defineWppSegmentedControl, [
    'size',
    'hugContentOff',
    'width',
    'variant',
...
export const WppSegmentedControlItem = defineContainer('wpp-segmented-control-item-v4-2-0', defineWppSegmentedControlItem, [
    'size',
    'active',
    'disabled',
    'value',
...
export const WppSelect = defineContainer('wpp-select-v4-2-0', defineWppSelect, [
    'consistentSearch',
    'value',
    'list',
    'type',
...
export const WppSideModal = defineContainer('wpp-side-modal-v4-2-0', defineWppSideModal, [
    'actionsConfig',
    'open',
    'size',
    'disableOutsideClick',
...
export const WppSkeleton = defineContainer('wpp-skeleton-v4-2-0', defineWppSkeleton, [
    'variant',
    'width',
    'height'
]);
export const WppSlider = defineContainer('wpp-slider-v4-2-0', defineWppSlider, [
    'name',
    'inputWidth',
    'value',
    'marks',
...
export const WppSortButton = defineContainer('wpp-sort-button-v4-2-0', defineWppSortButton, [
    'name',
    'ariaProps',
    'disabled',
    'autoFocus'
]);
export const WppSpinner = defineContainer('wpp-spinner-v4-2-0', defineWppSpinner, [
    'color',
    'size',
    'ariaProps'
]);
export const WppStep = defineContainer('wpp-step-v4-2-0', defineWppStep, [
    'active',
    'completed',
    'completedLine',
    'substep',
...
export const WppStepper = defineContainer('wpp-stepper-v4-2-0', defineWppStepper, [
    'activeStep',
    'stepAmount',
    'completedSteps',
    'stepperWidth',
...
export const WppStickyBar = defineContainer('wpp-sticky-bar-v4-2-0', defineWppStickyBar, [
    'variant',
    'barTitle',
    'offsetFromTop',
    'zIndex',
...
export const WppTab = defineContainer('wpp-tab-v4-2-0', defineWppTab, [
    'active',
    'disabled',
    'value',
    'counter',
...
export const WppTabs = defineContainer('wpp-tabs-v4-2-0', defineWppTabs, [
    'value',
    'size',
    'ariaProps',
    'locales',
...
export const WppTag = defineContainer('wpp-tag-v4-2-0', defineWppTag, [
    'variant',
    'maxLabelLength',
    'tooltipConfig',
    'label',
...
export const WppTextareaInput = defineContainer('wpp-textarea-input-v4-2-0', defineWppTextareaInput, [
    'name',
    'value',
    'placeholder',
    'required',
...
export const WppTimePicker = defineContainer('wpp-time-picker-v4-2-0', defineWppTimePicker, [
    'size',
    'disabled',
    'dropdownConfig',
    'placeholder',
...
export const WppToast = defineContainer('wpp-toast-v4-2-0', defineWppToast, [
    'variant',
    'index',
    'message',
    'header',
...
export const WppToastContainer = defineContainer('wpp-toast-container-v4-2-0', defineWppToastContainer, [
    'maxToastsToDisplay',
    'zIndex',
    'staggerInterval'
]);
export const WppToggle = defineContainer('wpp-toggle-v4-2-0', defineWppToggle, [
    'name',
    'value',
    'checked',
    'required',
...
export const WppTooltip = defineContainer('wpp-tooltip-v4-2-0', defineWppTooltip, [
    'disabled',
    'header',
    'text',
    'value',
...
export const WppTopbar = defineContainer('wpp-topbar-v4-2-0', defineWppTopbar, [
    'navigation',
    'value',
    'nativeLink',
    'zIndex',
...
export const WppTopbarItem = defineContainer('wpp-topbar-item-v4-2-0', defineWppTopbarItem, [
    'navigation',
    'firstLevel',
    'menu',
    'active',
...
export const WppTree = defineContainer('wpp-tree-v4-2-0', defineWppTree, [
    'data',
    'search',
    'multiple',
    'defaultSelectedIds',
...
export const WppTreeItem = defineContainer('wpp-tree-item-v4-2-0', defineWppTreeItem, [
    'text',
    'multiple',
    'search',
    'item',
...
export const WppTypography = defineContainer('wpp-typography-v4-2-0', defineWppTypography, [
    'type',
    'tag',
    'color'
]);
export const WppVideoPlayer = defineContainer('wpp-video-player-v4-2-0', defineWppVideoPlayer, [
    'src',
    'thumbnail',
    'caption',
    'type',
