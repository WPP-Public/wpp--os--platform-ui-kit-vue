...
export const WppAccordion = defineContainer('wpp-accordion-v3-6-0', defineWppAccordion, [
    'expandedByDefault',
    'expanded',
    'disabled',
    'withDivider',
...
export const WppActionButton = defineContainer('wpp-action-button-v3-6-0', defineWppActionButton, [
    'disabled',
    'loading',
    'variant',
    'autoFocus',
...
export const WppAutocomplete = defineContainer('wpp-autocomplete-v3-6-0', defineWppAutocomplete, [
    'name',
    'loading',
    'disabled',
    'autoFocus',
...
export const WppAvatar = defineContainer('wpp-avatar-v3-6-0', defineWppAvatar, [
    'name',
    'size',
    'variant',
    'src',
...
export const WppAvatarGroup = defineContainer('wpp-avatar-group-v3-6-0', defineWppAvatarGroup, [
    'users',
    'avatars',
    'maxAvatarsToDisplay',
    'size',
...
export const WppBackToTopButton = defineContainer('wpp-back-to-top-button-v3-6-0', defineWppBackToTopButton, [
    'ariaProps'
]);
export const WppBanner = defineContainer('wpp-banner-v3-6-0', defineWppBanner, [
    'ariaProps',
    'role',
    'show',
    'closable',
...
export const WppBreadcrumb = defineContainer('wpp-breadcrumb-v3-6-0', defineWppBreadcrumb, [
    'items',
    'maxLabelLength',
    'middleTruncation',
    'nativeLink',
...
export const WppButton = defineContainer('wpp-button-v3-6-0', defineWppButton, [
    'size',
    'disabled',
    'loading',
    'variant',
...
export const WppCard = defineContainer('wpp-card-v3-6-0', defineWppCard, [
    'variant',
    'value',
    'size',
    'type',
...
export const WppCardGroup = defineContainer('wpp-card-group-v3-6-0', defineWppCardGroup, [
    'name',
    'size',
    'value',
    'multiple',
...
export const WppChatConversation = defineContainer('wpp-chat-conversation-v3-6-0', defineWppChatConversation, [
    'messages',
...
export const WppChatConversationMessage = defineContainer('wpp-chat-conversation-message-v3-6-0', defineWppChatConversationMessage, [
    'role',
    'content',
    'status',
    'actionButtonsConfig',
...
export const WppChatInput = defineContainer('wpp-chat-input-v3-6-0', defineWppChatInput, [
    'size',
    'placeholder',
    'enableAttach',
    'enableMic',
...
export const WppCheckbox = defineContainer('wpp-checkbox-v3-6-0', defineWppCheckbox, [
    'name',
    'value',
    'checked',
    'controlled',
...
export const WppCheckboxGroup = defineContainer('wpp-checkbox-group-v3-6-0', defineWppCheckboxGroup, [
    'value',
    'required',
    'message',
    'messageType',
...
export const WppColorPicker = defineContainer('wpp-color-picker-v3-6-0', defineWppColorPicker, [
    'initialColor',
    'dropdownConfig',
    'type',
    'mode',
...
export const WppCounter = defineContainer('wpp-counter-v3-6-0', defineWppCounter, [
    'name',
    'value',
    'min',
    'max',
...
export const WppDatepicker = defineContainer('wpp-datepicker-v3-6-0', defineWppDatepicker, [
    'range',
    'toggleSelected',
    'value',
    'autoFocus',
...
export const WppDivider = defineContainer('wpp-divider-v3-6-0', defineWppDivider, [
    'vertical',
    'resizable'
]);
export const WppEmpty404 = defineContainer('wpp-empty-404-v3-6-0', defineWppEmpty404, [
    'width',
    'height'
]);
export const WppEmptyCards = defineContainer('wpp-empty-cards-v3-6-0', defineWppEmptyCards, [
    'width',
    'height'
]);
export const WppEmptyContent = defineContainer('wpp-empty-content-v3-6-0', defineWppEmptyContent, [
    'width',
    'height'
]);
export const WppEmptyDataviz = defineContainer('wpp-empty-dataviz-v3-6-0', defineWppEmptyDataviz, [
    'width',
    'height'
]);
export const WppEmptyDowntime = defineContainer('wpp-empty-downtime-v3-6-0', defineWppEmptyDowntime, [
    'width',
    'height'
]);
export const WppEmptyError = defineContainer('wpp-empty-error-v3-6-0', defineWppEmptyError, [
    'width',
    'height'
]);
export const WppEmptyFolder = defineContainer('wpp-empty-folder-v3-6-0', defineWppEmptyFolder, [
    'width',
    'height'
]);
export const WppEmptyNoAccess = defineContainer('wpp-empty-no-access-v3-6-0', defineWppEmptyNoAccess, [
    'width',
    'height'
]);
export const WppEmptyNoConnection = defineContainer('wpp-empty-no-connection-v3-6-0', defineWppEmptyNoConnection, [
    'width',
    'height'
]);
export const WppEmptyNothingFound = defineContainer('wpp-empty-nothing-found-v3-6-0', defineWppEmptyNothingFound, [
    'width',
    'height'
]);
export const WppEmptyNotifications = defineContainer('wpp-empty-notifications-v3-6-0', defineWppEmptyNotifications, [
    'width',
    'height'
]);
export const WppEmptyTable = defineContainer('wpp-empty-table-v3-6-0', defineWppEmptyTable, [
    'width',
    'height'
]);
export const WppExpandableCard = defineContainer('wpp-expandable-card-v3-6-0', defineWppExpandableCard, [
    'expandedByDefault',
    'expanded',
    'isExpanded',
    'size',
...
export const WppFileUpload = defineContainer('wpp-file-upload-v3-6-0', defineWppFileUpload, [
    'name',
    'value',
    'disabled',
    'multiple',
...
export const WppFileUploadItem = defineContainer('wpp-file-upload-item-v3-6-0', defineWppFileUploadItem, [
    'fileName',
    'file',
    'format',
    'maxLabelLength',
...
export const WppFilterButton = defineContainer('wpp-filter-button-v3-6-0', defineWppFilterButton, [
    'counter',
    'name',
    'ariaProps',
    'disabled',
...
export const WppFloatingButton = defineContainer('wpp-floating-button-v3-6-0', defineWppFloatingButton, [
    'disabled',
    'loading',
    'autoFocus',
    'name',
...
export const WppFloatingToolbar = defineContainer('wpp-floating-toolbar-v3-6-0', defineWppFloatingToolbar, [
    'actionButtonsConfig',
    'orientation',
    'ariaProps'
]);
export const WppFullScreenModal = defineContainer('wpp-full-screen-modal-v3-6-0', defineWppFullScreenModal, [
    'open',
    ...
    'wppFullScreenModalOpen'
]);
export const WppGrid = defineContainer('wpp-grid-v3-6-0', defineWppGrid, [
    'container',
    'item',
    'direction',
    'justifyContent',
...
export const WppIconAbout = defineContainer('wpp-icon-about-v3-6-0', defineWppIconAbout, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAccessibility = defineContainer('wpp-icon-accessibility-v3-6-0', defineWppIconAccessibility, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAccordion = defineContainer('wpp-icon-accordion-v3-6-0', defineWppIconAccordion, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAction = defineContainer('wpp-icon-action-v3-6-0', defineWppIconAction, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAdd = defineContainer('wpp-icon-add-v3-6-0', defineWppIconAdd, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAddApp = defineContainer('wpp-icon-add-app-v3-6-0', defineWppIconAddApp, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAddCircle = defineContainer('wpp-icon-add-circle-v3-6-0', defineWppIconAddCircle, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAddDocument = defineContainer('wpp-icon-add-document-v3-6-0', defineWppIconAddDocument, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAddFolder = defineContainer('wpp-icon-add-folder-v3-6-0', defineWppIconAddFolder, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAdmin = defineContainer('wpp-icon-admin-v3-6-0', defineWppIconAdmin, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAi = defineContainer('wpp-icon-ai-v3-6-0', defineWppIconAi, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAirPollution = defineContainer('wpp-icon-air-pollution-v3-6-0', defineWppIconAirPollution, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAirplane = defineContainer('wpp-icon-airplane-v3-6-0', defineWppIconAirplane, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAngry = defineContainer('wpp-icon-angry-v3-6-0', defineWppIconAngry, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconApp = defineContainer('wpp-icon-app-v3-6-0', defineWppIconApp, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAppFolder = defineContainer('wpp-icon-app-folder-v3-6-0', defineWppIconAppFolder, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAppStore = defineContainer('wpp-icon-app-store-v3-6-0', defineWppIconAppStore, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconApprovals = defineContainer('wpp-icon-approvals-v3-6-0', defineWppIconApprovals, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconArchive = defineContainer('wpp-icon-archive-v3-6-0', defineWppIconArchive, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconArchiveMultiple = defineContainer('wpp-icon-archive-multiple-v3-6-0', defineWppIconArchiveMultiple, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconArrow = defineContainer('wpp-icon-arrow-v3-6-0', defineWppIconArrow, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconAsk = defineContainer('wpp-icon-ask-v3-6-0', defineWppIconAsk, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAssistant = defineContainer('wpp-icon-assistant-v3-6-0', defineWppIconAssistant, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAtm = defineContainer('wpp-icon-atm-v3-6-0', defineWppIconAtm, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAttach = defineContainer('wpp-icon-attach-v3-6-0', defineWppIconAttach, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAutoSum = defineContainer('wpp-icon-auto-sum-v3-6-0', defineWppIconAutoSum, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAutofit = defineContainer('wpp-icon-autofit-v3-6-0', defineWppIconAutofit, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconAutofitHeight = defineContainer('wpp-icon-autofit-height-v3-6-0', defineWppIconAutofitHeight, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAutofitHeightDotted = defineContainer('wpp-icon-autofit-height-dotted-v3-6-0', defineWppIconAutofitHeightDotted, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAutofitWidth = defineContainer('wpp-icon-autofit-width-v3-6-0', defineWppIconAutofitWidth, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAutofitWidthDotted = defineContainer('wpp-icon-autofit-width-dotted-v3-6-0', defineWppIconAutofitWidthDotted, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAvailableCheckmark = defineContainer('wpp-icon-available-checkmark-v3-6-0', defineWppIconAvailableCheckmark, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconAvailableUpdate = defineContainer('wpp-icon-available-update-v3-6-0', defineWppIconAvailableUpdate, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBank = defineContainer('wpp-icon-bank-v3-6-0', defineWppIconBank, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBar = defineContainer('wpp-icon-bar-v3-6-0', defineWppIconBar, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBarChart = defineContainer('wpp-icon-bar-chart-v3-6-0', defineWppIconBarChart, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBarHorizontal = defineContainer('wpp-icon-bar-horizontal-v3-6-0', defineWppIconBarHorizontal, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBicycle = defineContainer('wpp-icon-bicycle-v3-6-0', defineWppIconBicycle, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBlockquote = defineContainer('wpp-icon-blockquote-v3-6-0', defineWppIconBlockquote, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBluetoothOff = defineContainer('wpp-icon-bluetooth-off-v3-6-0', defineWppIconBluetoothOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBluetoothOn = defineContainer('wpp-icon-bluetooth-on-v3-6-0', defineWppIconBluetoothOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBoard = defineContainer('wpp-icon-board-v3-6-0', defineWppIconBoard, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBold = defineContainer('wpp-icon-bold-v3-6-0', defineWppIconBold, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBook = defineContainer('wpp-icon-book-v3-6-0', defineWppIconBook, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBookContacts = defineContainer('wpp-icon-book-contacts-v3-6-0', defineWppIconBookContacts, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBookFaq = defineContainer('wpp-icon-book-faq-v3-6-0', defineWppIconBookFaq, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBookInformation = defineContainer('wpp-icon-book-information-v3-6-0', defineWppIconBookInformation, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBookSearch = defineContainer('wpp-icon-book-search-v3-6-0', defineWppIconBookSearch, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBookmark = defineContainer('wpp-icon-bookmark-v3-6-0', defineWppIconBookmark, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBookmarkAdd = defineContainer('wpp-icon-bookmark-add-v3-6-0', defineWppIconBookmarkAdd, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBookmarkFilled = defineContainer('wpp-icon-bookmark-filled-v3-6-0', defineWppIconBookmarkFilled, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBookmarkSelected = defineContainer('wpp-icon-bookmark-selected-v3-6-0', defineWppIconBookmarkSelected, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBorder = defineContainer('wpp-icon-border-v3-6-0', defineWppIconBorder, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconBorderAll = defineContainer('wpp-icon-border-all-v3-6-0', defineWppIconBorderAll, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBorderBottomDouble = defineContainer('wpp-icon-border-bottom-double-v3-6-0', defineWppIconBorderBottomDouble, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBorderLeftRight = defineContainer('wpp-icon-border-left-right-v3-6-0', defineWppIconBorderLeftRight, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBorderNone = defineContainer('wpp-icon-border-none-v3-6-0', defineWppIconBorderNone, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBorderOutside = defineContainer('wpp-icon-border-outside-v3-6-0', defineWppIconBorderOutside, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBorderOutsideThick = defineContainer('wpp-icon-border-outside-thick-v3-6-0', defineWppIconBorderOutsideThick, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBorderTopBottom = defineContainer('wpp-icon-border-top-bottom-v3-6-0', defineWppIconBorderTopBottom, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBorderTopBottomDouble = defineContainer('wpp-icon-border-top-bottom-double-v3-6-0', defineWppIconBorderTopBottomDouble, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBorderTopBottomThick = defineContainer('wpp-icon-border-top-bottom-thick-v3-6-0', defineWppIconBorderTopBottomThick, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBot = defineContainer('wpp-icon-bot-v3-6-0', defineWppIconBot, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBounce = defineContainer('wpp-icon-bounce-v3-6-0', defineWppIconBounce, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBranch = defineContainer('wpp-icon-branch-v3-6-0', defineWppIconBranch, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBranchRequest = defineContainer('wpp-icon-branch-request-v3-6-0', defineWppIconBranchRequest, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBranchReview = defineContainer('wpp-icon-branch-review-v3-6-0', defineWppIconBranchReview, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBtc = defineContainer('wpp-icon-btc-v3-6-0', defineWppIconBtc, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBus = defineContainer('wpp-icon-bus-v3-6-0', defineWppIconBus, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconBusiness = defineContainer('wpp-icon-business-v3-6-0', defineWppIconBusiness, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconButton = defineContainer('wpp-icon-button-v3-6-0', defineWppIconButton, [
    'size',
    'disabled',
    'loading',
    'name'
]);
export const WppIconCafe = defineContainer('wpp-icon-cafe-v3-6-0', defineWppIconCafe, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCalendar = defineContainer('wpp-icon-calendar-v3-6-0', defineWppIconCalendar, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCalendar3Days = defineContainer('wpp-icon-calendar-3-days-v3-6-0', defineWppIconCalendar3Days, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCalendarAdd = defineContainer('wpp-icon-calendar-add-v3-6-0', defineWppIconCalendarAdd, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCalendarDate = defineContainer('wpp-icon-calendar-date-v3-6-0', defineWppIconCalendarDate, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCalendarDismiss = defineContainer('wpp-icon-calendar-dismiss-v3-6-0', defineWppIconCalendarDismiss, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCalendarError = defineContainer('wpp-icon-calendar-error-v3-6-0', defineWppIconCalendarError, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCalendarMonth = defineContainer('wpp-icon-calendar-month-v3-6-0', defineWppIconCalendarMonth, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCameraAdd = defineContainer('wpp-icon-camera-add-v3-6-0', defineWppIconCameraAdd, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCameraOff = defineContainer('wpp-icon-camera-off-v3-6-0', defineWppIconCameraOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCameraOn = defineContainer('wpp-icon-camera-on-v3-6-0', defineWppIconCameraOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCameraSwitch = defineContainer('wpp-icon-camera-switch-v3-6-0', defineWppIconCameraSwitch, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCampaign = defineContainer('wpp-icon-campaign-v3-6-0', defineWppIconCampaign, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCaptionOff = defineContainer('wpp-icon-caption-off-v3-6-0', defineWppIconCaptionOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCaptionOn = defineContainer('wpp-icon-caption-on-v3-6-0', defineWppIconCaptionOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCarousel = defineContainer('wpp-icon-carousel-v3-6-0', defineWppIconCarousel, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCart = defineContainer('wpp-icon-cart-v3-6-0', defineWppIconCart, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCase = defineContainer('wpp-icon-case-v3-6-0', defineWppIconCase, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCast = defineContainer('wpp-icon-cast-v3-6-0', defineWppIconCast, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCellularData3g = defineContainer('wpp-icon-cellular-data-3g-v3-6-0', defineWppIconCellularData3g, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCellularData4g = defineContainer('wpp-icon-cellular-data-4g-v3-6-0', defineWppIconCellularData4g, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCellularData5g = defineContainer('wpp-icon-cellular-data-5g-v3-6-0', defineWppIconCellularData5g, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCellularDataOff = defineContainer('wpp-icon-cellular-data-off-v3-6-0', defineWppIconCellularDataOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCellularDataOn = defineContainer('wpp-icon-cellular-data-on-v3-6-0', defineWppIconCellularDataOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconChannel = defineContainer('wpp-icon-channel-v3-6-0', defineWppIconChannel, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconChatMessage = defineContainer('wpp-icon-chat-message-v3-6-0', defineWppIconChatMessage, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconChatMessageNew = defineContainer('wpp-icon-chat-message-new-v3-6-0', defineWppIconChatMessageNew, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconChatMessageOff = defineContainer('wpp-icon-chat-message-off-v3-6-0', defineWppIconChatMessageOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconChatVideo = defineContainer('wpp-icon-chat-video-v3-6-0', defineWppIconChatVideo, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconChevron = defineContainer('wpp-icon-chevron-v3-6-0', defineWppIconChevron, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconCinema = defineContainer('wpp-icon-cinema-v3-6-0', defineWppIconCinema, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCircle = defineContainer('wpp-icon-circle-v3-6-0', defineWppIconCircle, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconClock = defineContainer('wpp-icon-clock-v3-6-0', defineWppIconClock, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconClose = defineContainer('wpp-icon-close-v3-6-0', defineWppIconClose, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCloudDismiss = defineContainer('wpp-icon-cloud-dismiss-v3-6-0', defineWppIconCloudDismiss, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCloudSuccess = defineContainer('wpp-icon-cloud-success-v3-6-0', defineWppIconCloudSuccess, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCloudSync = defineContainer('wpp-icon-cloud-sync-v3-6-0', defineWppIconCloudSync, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCloudUpload = defineContainer('wpp-icon-cloud-upload-v3-6-0', defineWppIconCloudUpload, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCodeView = defineContainer('wpp-icon-code-view-v3-6-0', defineWppIconCodeView, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCollapse = defineContainer('wpp-icon-collapse-v3-6-0', defineWppIconCollapse, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCollection = defineContainer('wpp-icon-collection-v3-6-0', defineWppIconCollection, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconColor = defineContainer('wpp-icon-color-v3-6-0', defineWppIconColor, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconColour = defineContainer('wpp-icon-colour-v3-6-0', defineWppIconColour, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconColumnsOne = defineContainer('wpp-icon-columns-one-v3-6-0', defineWppIconColumnsOne, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconColumnsThree = defineContainer('wpp-icon-columns-three-v3-6-0', defineWppIconColumnsThree, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconColumnsTwo = defineContainer('wpp-icon-columns-two-v3-6-0', defineWppIconColumnsTwo, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconComment = defineContainer('wpp-icon-comment-v3-6-0', defineWppIconComment, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCommentOff = defineContainer('wpp-icon-comment-off-v3-6-0', defineWppIconCommentOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCommunication = defineContainer('wpp-icon-communication-v3-6-0', defineWppIconCommunication, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCompose = defineContainer('wpp-icon-compose-v3-6-0', defineWppIconCompose, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCookies = defineContainer('wpp-icon-cookies-v3-6-0', defineWppIconCookies, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCopy = defineContainer('wpp-icon-copy-v3-6-0', defineWppIconCopy, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCrop = defineContainer('wpp-icon-crop-v3-6-0', defineWppIconCrop, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCross = defineContainer('wpp-icon-cross-v3-6-0', defineWppIconCross, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCta = defineContainer('wpp-icon-cta-v3-6-0', defineWppIconCta, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCube = defineContainer('wpp-icon-cube-v3-6-0', defineWppIconCube, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCurrency = defineContainer('wpp-icon-currency-v3-6-0', defineWppIconCurrency, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconCut = defineContainer('wpp-icon-cut-v3-6-0', defineWppIconCut, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDarkTheme = defineContainer('wpp-icon-dark-theme-v3-6-0', defineWppIconDarkTheme, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDash = defineContainer('wpp-icon-dash-v3-6-0', defineWppIconDash, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataArea = defineContainer('wpp-icon-data-area-v3-6-0', defineWppIconDataArea, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataCloudOff = defineContainer('wpp-icon-data-cloud-off-v3-6-0', defineWppIconDataCloudOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataCloudOn = defineContainer('wpp-icon-data-cloud-on-v3-6-0', defineWppIconDataCloudOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataFunnel = defineContainer('wpp-icon-data-funnel-v3-6-0', defineWppIconDataFunnel, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataHistogram = defineContainer('wpp-icon-data-histogram-v3-6-0', defineWppIconDataHistogram, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataLine = defineContainer('wpp-icon-data-line-v3-6-0', defineWppIconDataLine, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataScatter = defineContainer('wpp-icon-data-scatter-v3-6-0', defineWppIconDataScatter, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataSunburst = defineContainer('wpp-icon-data-sunburst-v3-6-0', defineWppIconDataSunburst, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataTransfer = defineContainer('wpp-icon-data-transfer-v3-6-0', defineWppIconDataTransfer, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataTreemap = defineContainer('wpp-icon-data-treemap-v3-6-0', defineWppIconDataTreemap, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataTrending = defineContainer('wpp-icon-data-trending-v3-6-0', defineWppIconDataTrending, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataUsage = defineContainer('wpp-icon-data-usage-v3-6-0', defineWppIconDataUsage, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataViewCards = defineContainer('wpp-icon-data-view-cards-v3-6-0', defineWppIconDataViewCards, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataViewList = defineContainer('wpp-icon-data-view-list-v3-6-0', defineWppIconDataViewList, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataWaterfall = defineContainer('wpp-icon-data-waterfall-v3-6-0', defineWppIconDataWaterfall, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDataWhisker = defineContainer('wpp-icon-data-whisker-v3-6-0', defineWppIconDataWhisker, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDatabase = defineContainer('wpp-icon-database-v3-6-0', defineWppIconDatabase, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDecrease = defineContainer('wpp-icon-decrease-v3-6-0', defineWppIconDecrease, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDescent = defineContainer('wpp-icon-descent-v3-6-0', defineWppIconDescent, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDesign = defineContainer('wpp-icon-design-v3-6-0', defineWppIconDesign, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDesktop = defineContainer('wpp-icon-desktop-v3-6-0', defineWppIconDesktop, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDiamond = defineContainer('wpp-icon-diamond-v3-6-0', defineWppIconDiamond, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDirections = defineContainer('wpp-icon-directions-v3-6-0', defineWppIconDirections, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconDislike = defineContainer('wpp-icon-dislike-v3-6-0', defineWppIconDislike, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDislikeFilled = defineContainer('wpp-icon-dislike-filled-v3-6-0', defineWppIconDislikeFilled, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDiversity = defineContainer('wpp-icon-diversity-v3-6-0', defineWppIconDiversity, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDocument = defineContainer('wpp-icon-document-v3-6-0', defineWppIconDocument, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDocumentBlocked = defineContainer('wpp-icon-document-blocked-v3-6-0', defineWppIconDocumentBlocked, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDocumentError = defineContainer('wpp-icon-document-error-v3-6-0', defineWppIconDocumentError, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDollar = defineContainer('wpp-icon-dollar-v3-6-0', defineWppIconDollar, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDone = defineContainer('wpp-icon-done-v3-6-0', defineWppIconDone, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDoubleChevron = defineContainer('wpp-icon-double-chevron-v3-6-0', defineWppIconDoubleChevron, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconDownload = defineContainer('wpp-icon-download-v3-6-0', defineWppIconDownload, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDraft = defineContainer('wpp-icon-draft-v3-6-0', defineWppIconDraft, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDrag = defineContainer('wpp-icon-drag-v3-6-0', defineWppIconDrag, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDragAndDrop = defineContainer('wpp-icon-drag-and-drop-v3-6-0', defineWppIconDragAndDrop, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconDragIndicator = defineContainer('wpp-icon-drag-indicator-v3-6-0', defineWppIconDragIndicator, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEco = defineContainer('wpp-icon-eco-v3-6-0', defineWppIconEco, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEdit = defineContainer('wpp-icon-edit-v3-6-0', defineWppIconEdit, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEditText = defineContainer('wpp-icon-edit-text-v3-6-0', defineWppIconEditText, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEditorLowercase = defineContainer('wpp-icon-editor-lowercase-v3-6-0', defineWppIconEditorLowercase, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEditorObjectAlignmentCenter = defineContainer('wpp-icon-editor-object-alignment-center-v3-6-0', defineWppIconEditorObjectAlignmentCenter, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEditorTitle = defineContainer('wpp-icon-editor-title-v3-6-0', defineWppIconEditorTitle, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEditorUppercase = defineContainer('wpp-icon-editor-uppercase-v3-6-0', defineWppIconEditorUppercase, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEffects = defineContainer('wpp-icon-effects-v3-6-0', defineWppIconEffects, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEnlarge = defineContainer('wpp-icon-enlarge-v3-6-0', defineWppIconEnlarge, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEnter = defineContainer('wpp-icon-enter-v3-6-0', defineWppIconEnter, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEraser = defineContainer('wpp-icon-eraser-v3-6-0', defineWppIconEraser, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconError = defineContainer('wpp-icon-error-v3-6-0', defineWppIconError, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEth = defineContainer('wpp-icon-eth-v3-6-0', defineWppIconEth, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEuro = defineContainer('wpp-icon-euro-v3-6-0', defineWppIconEuro, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEvent = defineContainer('wpp-icon-event-v3-6-0', defineWppIconEvent, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconExpand = defineContainer('wpp-icon-expand-v3-6-0', defineWppIconExpand, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconExperiment = defineContainer('wpp-icon-experiment-v3-6-0', defineWppIconExperiment, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconExport = defineContainer('wpp-icon-export-v3-6-0', defineWppIconExport, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconExportFile = defineContainer('wpp-icon-export-file-v3-6-0', defineWppIconExportFile, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconExtension = defineContainer('wpp-icon-extension-v3-6-0', defineWppIconExtension, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconExternalLink = defineContainer('wpp-icon-external-link-v3-6-0', defineWppIconExternalLink, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEye = defineContainer('wpp-icon-eye-v3-6-0', defineWppIconEye, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEyeOff = defineContainer('wpp-icon-eye-off-v3-6-0', defineWppIconEyeOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEyeOn = defineContainer('wpp-icon-eye-on-v3-6-0', defineWppIconEyeOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconEyedropper = defineContainer('wpp-icon-eyedropper-v3-6-0', defineWppIconEyedropper, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFactory = defineContainer('wpp-icon-factory-v3-6-0', defineWppIconFactory, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFavorites = defineContainer('wpp-icon-favorites-v3-6-0', defineWppIconFavorites, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFavoritesFilled = defineContainer('wpp-icon-favorites-filled-v3-6-0', defineWppIconFavoritesFilled, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFavourites = defineContainer('wpp-icon-favourites-v3-6-0', defineWppIconFavourites, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFavouritesFilled = defineContainer('wpp-icon-favourites-filled-v3-6-0', defineWppIconFavouritesFilled, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFile = defineContainer('wpp-icon-file-v3-6-0', defineWppIconFile, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFileCss = defineContainer('wpp-icon-file-css-v3-6-0', defineWppIconFileCss, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFileJs = defineContainer('wpp-icon-file-js-v3-6-0', defineWppIconFileJs, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFilePdf = defineContainer('wpp-icon-file-pdf-v3-6-0', defineWppIconFilePdf, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFileZip = defineContainer('wpp-icon-file-zip-v3-6-0', defineWppIconFileZip, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFill = defineContainer('wpp-icon-fill-v3-6-0', defineWppIconFill, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFilter = defineContainer('wpp-icon-filter-v3-6-0', defineWppIconFilter, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFingerprint = defineContainer('wpp-icon-fingerprint-v3-6-0', defineWppIconFingerprint, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFitHeight = defineContainer('wpp-icon-fit-height-v3-6-0', defineWppIconFitHeight, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFitWidth = defineContainer('wpp-icon-fit-width-v3-6-0', defineWppIconFitWidth, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFlagOff = defineContainer('wpp-icon-flag-off-v3-6-0', defineWppIconFlagOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFlagOn = defineContainer('wpp-icon-flag-on-v3-6-0', defineWppIconFlagOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFlip = defineContainer('wpp-icon-flip-v3-6-0', defineWppIconFlip, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconFloatCenter = defineContainer('wpp-icon-float-center-v3-6-0', defineWppIconFloatCenter, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFloatLeft = defineContainer('wpp-icon-float-left-v3-6-0', defineWppIconFloatLeft, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFloatRight = defineContainer('wpp-icon-float-right-v3-6-0', defineWppIconFloatRight, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFluidWorkflow = defineContainer('wpp-icon-fluid-workflow-v3-6-0', defineWppIconFluidWorkflow, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFolder = defineContainer('wpp-icon-folder-v3-6-0', defineWppIconFolder, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFolderBlocked = defineContainer('wpp-icon-folder-blocked-v3-6-0', defineWppIconFolderBlocked, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFolderLink = defineContainer('wpp-icon-folder-link-v3-6-0', defineWppIconFolderLink, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFolderOpen = defineContainer('wpp-icon-folder-open-v3-6-0', defineWppIconFolderOpen, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFont = defineContainer('wpp-icon-font-v3-6-0', defineWppIconFont, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconForward = defineContainer('wpp-icon-forward-v3-6-0', defineWppIconForward, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFullscreen = defineContainer('wpp-icon-fullscreen-v3-6-0', defineWppIconFullscreen, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconFullscreenMinimise = defineContainer('wpp-icon-fullscreen-minimise-v3-6-0', defineWppIconFullscreenMinimise, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconGallery = defineContainer('wpp-icon-gallery-v3-6-0', defineWppIconGallery, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconGasStation = defineContainer('wpp-icon-gas-station-v3-6-0', defineWppIconGasStation, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconGear = defineContainer('wpp-icon-gear-v3-6-0', defineWppIconGear, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconGetSupport = defineContainer('wpp-icon-get-support-v3-6-0', defineWppIconGetSupport, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconGif = defineContainer('wpp-icon-gif-v3-6-0', defineWppIconGif, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconGlobe = defineContainer('wpp-icon-globe-v3-6-0', defineWppIconGlobe, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconGps = defineContainer('wpp-icon-gps-v3-6-0', defineWppIconGps, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconGraph = defineContainer('wpp-icon-graph-v3-6-0', defineWppIconGraph, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconGrid = defineContainer('wpp-icon-grid-v3-6-0', defineWppIconGrid, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconGridDots = defineContainer('wpp-icon-grid-dots-v3-6-0', defineWppIconGridDots, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconH1 = defineContainer('wpp-icon-h1-v3-6-0', defineWppIconH1, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconH2 = defineContainer('wpp-icon-h2-v3-6-0', defineWppIconH2, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconH3 = defineContainer('wpp-icon-h3-v3-6-0', defineWppIconH3, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHandDraw = defineContainer('wpp-icon-hand-draw-v3-6-0', defineWppIconHandDraw, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHandOff = defineContainer('wpp-icon-hand-off-v3-6-0', defineWppIconHandOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHandOn = defineContainer('wpp-icon-hand-on-v3-6-0', defineWppIconHandOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHash = defineContainer('wpp-icon-hash-v3-6-0', defineWppIconHash, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHd = defineContainer('wpp-icon-hd-v3-6-0', defineWppIconHd, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHdr = defineContainer('wpp-icon-hdr-v3-6-0', defineWppIconHdr, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHeadphones = defineContainer('wpp-icon-headphones-v3-6-0', defineWppIconHeadphones, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHelp = defineContainer('wpp-icon-help-v3-6-0', defineWppIconHelp, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconHistory = defineContainer('wpp-icon-history-v3-6-0', defineWppIconHistory, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHome = defineContainer('wpp-icon-home-v3-6-0', defineWppIconHome, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHomeCheckmark = defineContainer('wpp-icon-home-checkmark-v3-6-0', defineWppIconHomeCheckmark, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHospital = defineContainer('wpp-icon-hospital-v3-6-0', defineWppIconHospital, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconHub = defineContainer('wpp-icon-hub-v3-6-0', defineWppIconHub, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconIcons = defineContainer('wpp-icon-icons-v3-6-0', defineWppIconIcons, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconIdea = defineContainer('wpp-icon-idea-v3-6-0', defineWppIconIdea, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconIframe = defineContainer('wpp-icon-iframe-v3-6-0', defineWppIconIframe, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconImage = defineContainer('wpp-icon-image-v3-6-0', defineWppIconImage, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconImageOff = defineContainer('wpp-icon-image-off-v3-6-0', defineWppIconImageOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconImport = defineContainer('wpp-icon-import-v3-6-0', defineWppIconImport, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconInbox = defineContainer('wpp-icon-inbox-v3-6-0', defineWppIconInbox, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconIncognito = defineContainer('wpp-icon-incognito-v3-6-0', defineWppIconIncognito, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconIncomplete = defineContainer('wpp-icon-incomplete-v3-6-0', defineWppIconIncomplete, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconIncrease = defineContainer('wpp-icon-increase-v3-6-0', defineWppIconIncrease, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconIndentDecrease = defineContainer('wpp-icon-indent-decrease-v3-6-0', defineWppIconIndentDecrease, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconIndentIncrease = defineContainer('wpp-icon-indent-increase-v3-6-0', defineWppIconIndentIncrease, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconInfo = defineContainer('wpp-icon-info-v3-6-0', defineWppIconInfo, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconInfoMessage = defineContainer('wpp-icon-info-message-v3-6-0', defineWppIconInfoMessage, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconInstallUpdate = defineContainer('wpp-icon-install-update-v3-6-0', defineWppIconInstallUpdate, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconItalic = defineContainer('wpp-icon-italic-v3-6-0', defineWppIconItalic, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconJavaScript = defineContainer('wpp-icon-java-script-v3-6-0', defineWppIconJavaScript, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconJoin = defineContainer('wpp-icon-join-v3-6-0', defineWppIconJoin, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconKey = defineContainer('wpp-icon-key-v3-6-0', defineWppIconKey, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconKeyboard = defineContainer('wpp-icon-keyboard-v3-6-0', defineWppIconKeyboard, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLaptop = defineContainer('wpp-icon-laptop-v3-6-0', defineWppIconLaptop, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLaugh = defineContainer('wpp-icon-laugh-v3-6-0', defineWppIconLaugh, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLaunch = defineContainer('wpp-icon-launch-v3-6-0', defineWppIconLaunch, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLayer = defineContainer('wpp-icon-layer-v3-6-0', defineWppIconLayer, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLeaf = defineContainer('wpp-icon-leaf-v3-6-0', defineWppIconLeaf, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLibrary = defineContainer('wpp-icon-library-v3-6-0', defineWppIconLibrary, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLibraryBuilding = defineContainer('wpp-icon-library-building-v3-6-0', defineWppIconLibraryBuilding, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLike = defineContainer('wpp-icon-like-v3-6-0', defineWppIconLike, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLikeFilled = defineContainer('wpp-icon-like-filled-v3-6-0', defineWppIconLikeFilled, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLikeOff = defineContainer('wpp-icon-like-off-v3-6-0', defineWppIconLikeOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLikeOn = defineContainer('wpp-icon-like-on-v3-6-0', defineWppIconLikeOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLink = defineContainer('wpp-icon-link-v3-6-0', defineWppIconLink, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLive = defineContainer('wpp-icon-live-v3-6-0', defineWppIconLive, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLocation = defineContainer('wpp-icon-location-v3-6-0', defineWppIconLocation, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLockOff = defineContainer('wpp-icon-lock-off-v3-6-0', defineWppIconLockOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLockOn = defineContainer('wpp-icon-lock-on-v3-6-0', defineWppIconLockOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLodging = defineContainer('wpp-icon-lodging-v3-6-0', defineWppIconLodging, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLogin = defineContainer('wpp-icon-login-v3-6-0', defineWppIconLogin, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconLogout = defineContainer('wpp-icon-logout-v3-6-0', defineWppIconLogout, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMagicWand = defineContainer('wpp-icon-magic-wand-v3-6-0', defineWppIconMagicWand, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMail = defineContainer('wpp-icon-mail-v3-6-0', defineWppIconMail, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMailAdd = defineContainer('wpp-icon-mail-add-v3-6-0', defineWppIconMailAdd, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMailAllRead = defineContainer('wpp-icon-mail-all-read-v3-6-0', defineWppIconMailAllRead, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMailBlocked = defineContainer('wpp-icon-mail-blocked-v3-6-0', defineWppIconMailBlocked, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMailCopy = defineContainer('wpp-icon-mail-copy-v3-6-0', defineWppIconMailCopy, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMailOff = defineContainer('wpp-icon-mail-off-v3-6-0', defineWppIconMailOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMailRead = defineContainer('wpp-icon-mail-read-v3-6-0', defineWppIconMailRead, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMap = defineContainer('wpp-icon-map-v3-6-0', defineWppIconMap, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMathFormula = defineContainer('wpp-icon-math-formula-v3-6-0', defineWppIconMathFormula, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMaximise = defineContainer('wpp-icon-maximise-v3-6-0', defineWppIconMaximise, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconMeet = defineContainer('wpp-icon-meet-v3-6-0', defineWppIconMeet, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMention = defineContainer('wpp-icon-mention-v3-6-0', defineWppIconMention, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMerge = defineContainer('wpp-icon-merge-v3-6-0', defineWppIconMerge, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconMicBlocked = defineContainer('wpp-icon-mic-blocked-v3-6-0', defineWppIconMicBlocked, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMicOff = defineContainer('wpp-icon-mic-off-v3-6-0', defineWppIconMicOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMicOn = defineContainer('wpp-icon-mic-on-v3-6-0', defineWppIconMicOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMinimise = defineContainer('wpp-icon-minimise-v3-6-0', defineWppIconMinimise, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconMobile = defineContainer('wpp-icon-mobile-v3-6-0', defineWppIconMobile, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMoney = defineContainer('wpp-icon-money-v3-6-0', defineWppIconMoney, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMore = defineContainer('wpp-icon-more-v3-6-0', defineWppIconMore, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconMove = defineContainer('wpp-icon-move-v3-6-0', defineWppIconMove, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMovie = defineContainer('wpp-icon-movie-v3-6-0', defineWppIconMovie, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMultipleEmotions = defineContainer('wpp-icon-multiple-emotions-v3-6-0', defineWppIconMultipleEmotions, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconMusic = defineContainer('wpp-icon-music-v3-6-0', defineWppIconMusic, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNavigationMenu = defineContainer('wpp-icon-navigation-menu-v3-6-0', defineWppIconNavigationMenu, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNeutral = defineContainer('wpp-icon-neutral-v3-6-0', defineWppIconNeutral, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNeutralTrading = defineContainer('wpp-icon-neutral-trading-v3-6-0', defineWppIconNeutralTrading, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNewspaper = defineContainer('wpp-icon-newspaper-v3-6-0', defineWppIconNewspaper, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNext = defineContainer('wpp-icon-next-v3-6-0', defineWppIconNext, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNightLife = defineContainer('wpp-icon-night-life-v3-6-0', defineWppIconNightLife, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNote = defineContainer('wpp-icon-note-v3-6-0', defineWppIconNote, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNotification = defineContainer('wpp-icon-notification-v3-6-0', defineWppIconNotification, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNotificationNew = defineContainer('wpp-icon-notification-new-v3-6-0', defineWppIconNotificationNew, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNotificationOff = defineContainer('wpp-icon-notification-off-v3-6-0', defineWppIconNotificationOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNotificationOn = defineContainer('wpp-icon-notification-on-v3-6-0', defineWppIconNotificationOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNotificationPause = defineContainer('wpp-icon-notification-pause-v3-6-0', defineWppIconNotificationPause, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNuclearDanger = defineContainer('wpp-icon-nuclear-danger-v3-6-0', defineWppIconNuclearDanger, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconNumber = defineContainer('wpp-icon-number-v3-6-0', defineWppIconNumber, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconObjectAlignment = defineContainer('wpp-icon-object-alignment-v3-6-0', defineWppIconObjectAlignment, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconObjectAlignmentCenter = defineContainer('wpp-icon-object-alignment-center-v3-6-0', defineWppIconObjectAlignmentCenter, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconOrderedList = defineContainer('wpp-icon-ordered-list-v3-6-0', defineWppIconOrderedList, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconOrganization = defineContainer('wpp-icon-organization-v3-6-0', defineWppIconOrganization, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconOrientation = defineContainer('wpp-icon-orientation-v3-6-0', defineWppIconOrientation, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconOutdoor = defineContainer('wpp-icon-outdoor-v3-6-0', defineWppIconOutdoor, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconOutdoorMedia = defineContainer('wpp-icon-outdoor-media-v3-6-0', defineWppIconOutdoorMedia, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconOwner = defineContainer('wpp-icon-owner-v3-6-0', defineWppIconOwner, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPadding = defineContainer('wpp-icon-padding-v3-6-0', defineWppIconPadding, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconPair = defineContainer('wpp-icon-pair-v3-6-0', defineWppIconPair, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconParking = defineContainer('wpp-icon-parking-v3-6-0', defineWppIconParking, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPaste = defineContainer('wpp-icon-paste-v3-6-0', defineWppIconPaste, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPause = defineContainer('wpp-icon-pause-v3-6-0', defineWppIconPause, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPen = defineContainer('wpp-icon-pen-v3-6-0', defineWppIconPen, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPending = defineContainer('wpp-icon-pending-v3-6-0', defineWppIconPending, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPentagon = defineContainer('wpp-icon-pentagon-v3-6-0', defineWppIconPentagon, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPeople = defineContainer('wpp-icon-people-v3-6-0', defineWppIconPeople, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPharmacy = defineContainer('wpp-icon-pharmacy-v3-6-0', defineWppIconPharmacy, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPhone = defineContainer('wpp-icon-phone-v3-6-0', defineWppIconPhone, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPieChart = defineContainer('wpp-icon-pie-chart-v3-6-0', defineWppIconPieChart, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPin = defineContainer('wpp-icon-pin-v3-6-0', defineWppIconPin, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPinned = defineContainer('wpp-icon-pinned-v3-6-0', defineWppIconPinned, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPitch = defineContainer('wpp-icon-pitch-v3-6-0', defineWppIconPitch, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPlay = defineContainer('wpp-icon-play-v3-6-0', defineWppIconPlay, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPlus = defineContainer('wpp-icon-plus-v3-6-0', defineWppIconPlus, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPlusCircle = defineContainer('wpp-icon-plus-circle-v3-6-0', defineWppIconPlusCircle, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPolice = defineContainer('wpp-icon-police-v3-6-0', defineWppIconPolice, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPost = defineContainer('wpp-icon-post-v3-6-0', defineWppIconPost, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPound = defineContainer('wpp-icon-pound-v3-6-0', defineWppIconPound, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPremium = defineContainer('wpp-icon-premium-v3-6-0', defineWppIconPremium, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPrevious = defineContainer('wpp-icon-previous-v3-6-0', defineWppIconPrevious, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPrint = defineContainer('wpp-icon-print-v3-6-0', defineWppIconPrint, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconPrivateAccount = defineContainer('wpp-icon-private-account-v3-6-0', defineWppIconPrivateAccount, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconQa = defineContainer('wpp-icon-qa-v3-6-0', defineWppIconQa, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconQrCode = defineContainer('wpp-icon-qr-code-v3-6-0', defineWppIconQrCode, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRadio = defineContainer('wpp-icon-radio-v3-6-0', defineWppIconRadio, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRanking = defineContainer('wpp-icon-ranking-v3-6-0', defineWppIconRanking, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRatio = defineContainer('wpp-icon-ratio-v3-6-0', defineWppIconRatio, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRecord = defineContainer('wpp-icon-record-v3-6-0', defineWppIconRecord, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRecordStop = defineContainer('wpp-icon-record-stop-v3-6-0', defineWppIconRecordStop, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRectangle = defineContainer('wpp-icon-rectangle-v3-6-0', defineWppIconRectangle, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRecycle = defineContainer('wpp-icon-recycle-v3-6-0', defineWppIconRecycle, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRedo = defineContainer('wpp-icon-redo-v3-6-0', defineWppIconRedo, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRefresh = defineContainer('wpp-icon-refresh-v3-6-0', defineWppIconRefresh, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRefreshDashed = defineContainer('wpp-icon-refresh-dashed-v3-6-0', defineWppIconRefreshDashed, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconReject = defineContainer('wpp-icon-reject-v3-6-0', defineWppIconReject, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRemove = defineContainer('wpp-icon-remove-v3-6-0', defineWppIconRemove, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRemoveApp = defineContainer('wpp-icon-remove-app-v3-6-0', defineWppIconRemoveApp, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRemoveCircle = defineContainer('wpp-icon-remove-circle-v3-6-0', defineWppIconRemoveCircle, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRepeatOff = defineContainer('wpp-icon-repeat-off-v3-6-0', defineWppIconRepeatOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRepeatOn = defineContainer('wpp-icon-repeat-on-v3-6-0', defineWppIconRepeatOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconReply = defineContainer('wpp-icon-reply-v3-6-0', defineWppIconReply, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconReplyAll = defineContainer('wpp-icon-reply-all-v3-6-0', defineWppIconReplyAll, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconReset = defineContainer('wpp-icon-reset-v3-6-0', defineWppIconReset, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconResetDashed = defineContainer('wpp-icon-reset-dashed-v3-6-0', defineWppIconResetDashed, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconResize = defineContainer('wpp-icon-resize-v3-6-0', defineWppIconResize, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconResizeLarge = defineContainer('wpp-icon-resize-large-v3-6-0', defineWppIconResizeLarge, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconResizeSmall = defineContainer('wpp-icon-resize-small-v3-6-0', defineWppIconResizeSmall, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRestaurant = defineContainer('wpp-icon-restaurant-v3-6-0', defineWppIconRestaurant, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRhombus = defineContainer('wpp-icon-rhombus-v3-6-0', defineWppIconRhombus, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRise = defineContainer('wpp-icon-rise-v3-6-0', defineWppIconRise, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRotate = defineContainer('wpp-icon-rotate-v3-6-0', defineWppIconRotate, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconRotateClockwise = defineContainer('wpp-icon-rotate-clockwise-v3-6-0', defineWppIconRotateClockwise, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRotateCounterclockwise = defineContainer('wpp-icon-rotate-counterclockwise-v3-6-0', defineWppIconRotateCounterclockwise, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRss = defineContainer('wpp-icon-rss-v3-6-0', defineWppIconRss, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconRupee = defineContainer('wpp-icon-rupee-v3-6-0', defineWppIconRupee, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSad = defineContainer('wpp-icon-sad-v3-6-0', defineWppIconSad, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSadSlightly = defineContainer('wpp-icon-sad-slightly-v3-6-0', defineWppIconSadSlightly, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconScale = defineContainer('wpp-icon-scale-v3-6-0', defineWppIconScale, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconScaleBottom = defineContainer('wpp-icon-scale-bottom-v3-6-0', defineWppIconScaleBottom, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconScan = defineContainer('wpp-icon-scan-v3-6-0', defineWppIconScan, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSchool = defineContainer('wpp-icon-school-v3-6-0', defineWppIconSchool, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSearch = defineContainer('wpp-icon-search-v3-6-0', defineWppIconSearch, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSegmentedControl = defineContainer('wpp-icon-segmented-control-v3-6-0', defineWppIconSegmentedControl, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSelectObject = defineContainer('wpp-icon-select-object-v3-6-0', defineWppIconSelectObject, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSend = defineContainer('wpp-icon-send-v3-6-0', defineWppIconSend, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSendOff = defineContainer('wpp-icon-send-off-v3-6-0', defineWppIconSendOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconService = defineContainer('wpp-icon-service-v3-6-0', defineWppIconService, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconShapes = defineContainer('wpp-icon-shapes-v3-6-0', defineWppIconShapes, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconShare = defineContainer('wpp-icon-share-v3-6-0', defineWppIconShare, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconShield = defineContainer('wpp-icon-shield-v3-6-0', defineWppIconShield, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconShieldCheckmark = defineContainer('wpp-icon-shield-checkmark-v3-6-0', defineWppIconShieldCheckmark, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconShieldDismiss = defineContainer('wpp-icon-shield-dismiss-v3-6-0', defineWppIconShieldDismiss, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconShieldError = defineContainer('wpp-icon-shield-error-v3-6-0', defineWppIconShieldError, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconShieldSuccess = defineContainer('wpp-icon-shield-success-v3-6-0', defineWppIconShieldSuccess, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconShip = defineContainer('wpp-icon-ship-v3-6-0', defineWppIconShip, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconShopping = defineContainer('wpp-icon-shopping-v3-6-0', defineWppIconShopping, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconShutDown = defineContainer('wpp-icon-shut-down-v3-6-0', defineWppIconShutDown, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSmartwatch = defineContainer('wpp-icon-smartwatch-v3-6-0', defineWppIconSmartwatch, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSmile = defineContainer('wpp-icon-smile-v3-6-0', defineWppIconSmile, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSmileSlightly = defineContainer('wpp-icon-smile-slightly-v3-6-0', defineWppIconSmileSlightly, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSocialMedia = defineContainer('wpp-icon-social-media-v3-6-0', defineWppIconSocialMedia, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSort = defineContainer('wpp-icon-sort-v3-6-0', defineWppIconSort, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSortByDecrease = defineContainer('wpp-icon-sort-by-decrease-v3-6-0', defineWppIconSortByDecrease, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSortByIncrease = defineContainer('wpp-icon-sort-by-increase-v3-6-0', defineWppIconSortByIncrease, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSortDecrease = defineContainer('wpp-icon-sort-decrease-v3-6-0', defineWppIconSortDecrease, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSortIncrease = defineContainer('wpp-icon-sort-increase-v3-6-0', defineWppIconSortIncrease, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSparkle = defineContainer('wpp-icon-sparkle-v3-6-0', defineWppIconSparkle, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSpeaker = defineContainer('wpp-icon-speaker-v3-6-0', defineWppIconSpeaker, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSpeakerBluetooth = defineContainer('wpp-icon-speaker-bluetooth-v3-6-0', defineWppIconSpeakerBluetooth, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSpeakerMute = defineContainer('wpp-icon-speaker-mute-v3-6-0', defineWppIconSpeakerMute, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSpeakerOff = defineContainer('wpp-icon-speaker-off-v3-6-0', defineWppIconSpeakerOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSplit = defineContainer('wpp-icon-split-v3-6-0', defineWppIconSplit, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconSport = defineContainer('wpp-icon-sport-v3-6-0', defineWppIconSport, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSpreadsheet = defineContainer('wpp-icon-spreadsheet-v3-6-0', defineWppIconSpreadsheet, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSquare = defineContainer('wpp-icon-square-v3-6-0', defineWppIconSquare, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSquareHint = defineContainer('wpp-icon-square-hint-v3-6-0', defineWppIconSquareHint, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconStatisticDocument = defineContainer('wpp-icon-statistic-document-v3-6-0', defineWppIconStatisticDocument, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSticker = defineContainer('wpp-icon-sticker-v3-6-0', defineWppIconSticker, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconStop = defineContainer('wpp-icon-stop-v3-6-0', defineWppIconStop, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconStrikeThrough = defineContainer('wpp-icon-strike-through-v3-6-0', defineWppIconStrikeThrough, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconStyleguide = defineContainer('wpp-icon-styleguide-v3-6-0', defineWppIconStyleguide, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSubItems = defineContainer('wpp-icon-sub-items-v3-6-0', defineWppIconSubItems, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSubscribe = defineContainer('wpp-icon-subscribe-v3-6-0', defineWppIconSubscribe, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSuccess = defineContainer('wpp-icon-success-v3-6-0', defineWppIconSuccess, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSupermarket = defineContainer('wpp-icon-supermarket-v3-6-0', defineWppIconSupermarket, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSupport = defineContainer('wpp-icon-support-v3-6-0', defineWppIconSupport, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSupportChat = defineContainer('wpp-icon-support-chat-v3-6-0', defineWppIconSupportChat, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSurprise = defineContainer('wpp-icon-surprise-v3-6-0', defineWppIconSurprise, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSymbols = defineContainer('wpp-icon-symbols-v3-6-0', defineWppIconSymbols, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconSync = defineContainer('wpp-icon-sync-v3-6-0', defineWppIconSync, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTableDefault = defineContainer('wpp-icon-table-default-v3-6-0', defineWppIconTableDefault, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTableDismiss = defineContainer('wpp-icon-table-dismiss-v3-6-0', defineWppIconTableDismiss, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTableEdit = defineContainer('wpp-icon-table-edit-v3-6-0', defineWppIconTableEdit, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTableLink = defineContainer('wpp-icon-table-link-v3-6-0', defineWppIconTableLink, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTableSimple = defineContainer('wpp-icon-table-simple-v3-6-0', defineWppIconTableSimple, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTableSort = defineContainer('wpp-icon-table-sort-v3-6-0', defineWppIconTableSort, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconTableSortAsc = defineContainer('wpp-icon-table-sort-asc-v3-6-0', defineWppIconTableSortAsc, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconTableSortAscHover = defineContainer('wpp-icon-table-sort-asc-hover-v3-6-0', defineWppIconTableSortAscHover, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconTableSortAscPressed = defineContainer('wpp-icon-table-sort-asc-pressed-v3-6-0', defineWppIconTableSortAscPressed, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconTableSortDesc = defineContainer('wpp-icon-table-sort-desc-v3-6-0', defineWppIconTableSortDesc, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconTableSortDescHover = defineContainer('wpp-icon-table-sort-desc-hover-v3-6-0', defineWppIconTableSortDescHover, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconTableSortDescPressed = defineContainer('wpp-icon-table-sort-desc-pressed-v3-6-0', defineWppIconTableSortDescPressed, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconTableSortHover = defineContainer('wpp-icon-table-sort-hover-v3-6-0', defineWppIconTableSortHover, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconTableSortPressed = defineContainer('wpp-icon-table-sort-pressed-v3-6-0', defineWppIconTableSortPressed, [
    'size',
    'width',
    'height',
    'color',
...
export const WppIconTableSortWrapper = defineContainer('wpp-icon-table-sort-wrapper-v3-6-0', defineWppIconTableSortWrapper, [
    'size',
    'width',
    'height',
    'direction',
...
export const WppIconTablet = defineContainer('wpp-icon-tablet-v3-6-0', defineWppIconTablet, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTag = defineContainer('wpp-icon-tag-v3-6-0', defineWppIconTag, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTarget = defineContainer('wpp-icon-target-v3-6-0', defineWppIconTarget, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTaskList = defineContainer('wpp-icon-task-list-v3-6-0', defineWppIconTaskList, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTaskListSquare = defineContainer('wpp-icon-task-list-square-v3-6-0', defineWppIconTaskListSquare, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconText = defineContainer('wpp-icon-text-v3-6-0', defineWppIconText, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTextAlignmentCenter = defineContainer('wpp-icon-text-alignment-center-v3-6-0', defineWppIconTextAlignmentCenter, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTextAlignmentDistribute = defineContainer('wpp-icon-text-alignment-distribute-v3-6-0', defineWppIconTextAlignmentDistribute, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTextAlignmentDistributeVertical = defineContainer('wpp-icon-text-alignment-distribute-vertical-v3-6-0', defineWppIconTextAlignmentDistributeVertical, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTextAlignmentJustify = defineContainer('wpp-icon-text-alignment-justify-v3-6-0', defineWppIconTextAlignmentJustify, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTextAlignmentJustifyLow = defineContainer('wpp-icon-text-alignment-justify-low-v3-6-0', defineWppIconTextAlignmentJustifyLow, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTextAlignmentLeft = defineContainer('wpp-icon-text-alignment-left-v3-6-0', defineWppIconTextAlignmentLeft, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTextAlignmentRight = defineContainer('wpp-icon-text-alignment-right-v3-6-0', defineWppIconTextAlignmentRight, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTheatre = defineContainer('wpp-icon-theatre-v3-6-0', defineWppIconTheatre, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconThumbsDown = defineContainer('wpp-icon-thumbs-down-v3-6-0', defineWppIconThumbsDown, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconThumbsDownFilled = defineContainer('wpp-icon-thumbs-down-filled-v3-6-0', defineWppIconThumbsDownFilled, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconThumbsUp = defineContainer('wpp-icon-thumbs-up-v3-6-0', defineWppIconThumbsUp, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconThumbsUpFilled = defineContainer('wpp-icon-thumbs-up-filled-v3-6-0', defineWppIconThumbsUpFilled, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTick = defineContainer('wpp-icon-tick-v3-6-0', defineWppIconTick, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTourism = defineContainer('wpp-icon-tourism-v3-6-0', defineWppIconTourism, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTrain = defineContainer('wpp-icon-train-v3-6-0', defineWppIconTrain, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTranslate = defineContainer('wpp-icon-translate-v3-6-0', defineWppIconTranslate, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTrash = defineContainer('wpp-icon-trash-v3-6-0', defineWppIconTrash, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTrendAscend = defineContainer('wpp-icon-trend-ascend-v3-6-0', defineWppIconTrendAscend, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTrendDescent = defineContainer('wpp-icon-trend-descent-v3-6-0', defineWppIconTrendDescent, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTriangle = defineContainer('wpp-icon-triangle-v3-6-0', defineWppIconTriangle, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTriangleFill = defineContainer('wpp-icon-triangle-fill-v3-6-0', defineWppIconTriangleFill, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTune = defineContainer('wpp-icon-tune-v3-6-0', defineWppIconTune, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTv = defineContainer('wpp-icon-tv-v3-6-0', defineWppIconTv, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconTwentyFourHours = defineContainer('wpp-icon-twenty-four-hours-v3-6-0', defineWppIconTwentyFourHours, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUnderline = defineContainer('wpp-icon-underline-v3-6-0', defineWppIconUnderline, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUndo = defineContainer('wpp-icon-undo-v3-6-0', defineWppIconUndo, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUnlink = defineContainer('wpp-icon-unlink-v3-6-0', defineWppIconUnlink, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUnorderedList = defineContainer('wpp-icon-unordered-list-v3-6-0', defineWppIconUnorderedList, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUnpinned = defineContainer('wpp-icon-unpinned-v3-6-0', defineWppIconUnpinned, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUpload = defineContainer('wpp-icon-upload-v3-6-0', defineWppIconUpload, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUser = defineContainer('wpp-icon-user-v3-6-0', defineWppIconUser, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUserAdd = defineContainer('wpp-icon-user-add-v3-6-0', defineWppIconUserAdd, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUserBlock = defineContainer('wpp-icon-user-block-v3-6-0', defineWppIconUserBlock, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUserChat = defineContainer('wpp-icon-user-chat-v3-6-0', defineWppIconUserChat, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUserSearch = defineContainer('wpp-icon-user-search-v3-6-0', defineWppIconUserSearch, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUserStarred = defineContainer('wpp-icon-user-starred-v3-6-0', defineWppIconUserStarred, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconUserTag = defineContainer('wpp-icon-user-tag-v3-6-0', defineWppIconUserTag, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconVideoBlocked = defineContainer('wpp-icon-video-blocked-v3-6-0', defineWppIconVideoBlocked, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconVideoClip = defineContainer('wpp-icon-video-clip-v3-6-0', defineWppIconVideoClip, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconVideoOff = defineContainer('wpp-icon-video-off-v3-6-0', defineWppIconVideoOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconVideoOn = defineContainer('wpp-icon-video-on-v3-6-0', defineWppIconVideoOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconVr = defineContainer('wpp-icon-vr-v3-6-0', defineWppIconVr, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconWarning = defineContainer('wpp-icon-warning-v3-6-0', defineWppIconWarning, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconWifiOff = defineContainer('wpp-icon-wifi-off-v3-6-0', defineWppIconWifiOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconWifiOn = defineContainer('wpp-icon-wifi-on-v3-6-0', defineWppIconWifiOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconWifiWarning = defineContainer('wpp-icon-wifi-warning-v3-6-0', defineWppIconWifiWarning, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconWithHand = defineContainer('wpp-icon-with-hand-v3-6-0', defineWppIconWithHand, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconWorkshop = defineContainer('wpp-icon-workshop-v3-6-0', defineWppIconWorkshop, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconWrapOff = defineContainer('wpp-icon-wrap-off-v3-6-0', defineWppIconWrapOff, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconWrapOn = defineContainer('wpp-icon-wrap-on-v3-6-0', defineWppIconWrapOn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconYen = defineContainer('wpp-icon-yen-v3-6-0', defineWppIconYen, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconYuan = defineContainer('wpp-icon-yuan-v3-6-0', defineWppIconYuan, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconZoo = defineContainer('wpp-icon-zoo-v3-6-0', defineWppIconZoo, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconZoomIn = defineContainer('wpp-icon-zoom-in-v3-6-0', defineWppIconZoomIn, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppIconZoomOut = defineContainer('wpp-icon-zoom-out-v3-6-0', defineWppIconZoomOut, [
    'size',
    'width',
    'height',
    'color'
]);
export const WppInlineEdit = defineContainer('wpp-inline-edit-v3-6-0', defineWppInlineEdit, [
    'mode',
    'value',
    'placeholder',
    'dropdownConfig',
...
export const WppInlineMessage = defineContainer('wpp-inline-message-v3-6-0', defineWppInlineMessage, [
    'titleText',
    'actionBtnText',
    'message',
    'type',
...
export const WppInput = defineContainer('wpp-input-v3-6-0', defineWppInput, [
    'name',
    'type',
    'value',
    'defaultValue',
...
export const WppInternalLabel = defineContainer('wpp-internal-label-v3-6-0', defineWppInternalLabel, [
    'labelText',
    'description',
    'optional',
    'typography',
...
export const WppLabel = defineContainer('wpp-label-v3-6-0', defineWppLabel, [
    'description',
    'htmlFor',
    'optional',
    'typography',
...
export const WppLegend = defineContainer('wpp-legend-v3-6-0', defineWppLegend, [
    'label',
    'disabled',
    'color'
]);
export const WppListItem = defineContainer('wpp-list-item-v3-6-0', defineWppListItem, [
    'labelTypography',
    'captionTypography',
    'value',
    'label',
...
export const WppLoadMore = defineContainer('wpp-load-more-v3-6-0', defineWppLoadMore, [
    'totalItems',
    'itemsLoaded',
    'showProgressBar',
    'loading',
...
export const WppMenuContext = defineContainer('wpp-menu-context-v3-6-0', defineWppMenuContext, [
    'listWidth',
    'dropdownConfig',
    'appendToListWrapper',
    'externalClass',
...
export const WppMenuGroup = defineContainer('wpp-menu-group-v3-6-0', defineWppMenuGroup, [
    'header',
    'withDivider'
]);
export const WppModal = defineContainer('wpp-modal-v3-6-0', defineWppModal, [
    'open',
    'size',
    'withTransparentOverlay',
    'disableOutsideClick',
...
export const WppMoreButton = defineContainer('wpp-more-button-v3-6-0', defineWppMoreButton, [
    'name',
    'size',
    'disabled',
    'loading',
...
export const WppNavSidebar = defineContainer('wpp-nav-sidebar-v3-6-0', defineWppNavSidebar, [
    'initialPath',
    'activePath',
    'nativeLink',
    'zIndex',
...
export const WppNavSidebarItem = defineContainer('wpp-nav-sidebar-item-v3-6-0', defineWppNavSidebarItem, [
    'expanded',
    'extended',
...
export const WppNavigationItem = defineContainer('wpp-navigation-item-v3-6-0', defineWppNavigationItem, [
    'menuExpanded',
    'label',
    'value',
    'path',
...
export const WppOverlay = defineContainer('wpp-overlay-v3-6-0', defineWppOverlay, [
    'isVisible',
    'zIndex',
    'wppClick'
]);
export const WppPagination = defineContainer('wpp-pagination-v3-6-0', defineWppPagination, [
    'count',
    'itemsPerPage',
    'selectedItemPerPage',
    'pageSelectThreshold',
...
export const WppPaginationItem = defineContainer('wpp-pagination-item-v3-6-0', defineWppPaginationItem, [
    'number',
    'selected',
    'wppPageChange'
]);
export const WppPaginationSelect = defineContainer('wpp-pagination-select-v3-6-0', defineWppPaginationSelect, [
    'count',
    'pageSelectThreshold',
    'activePageNumber',
    'wppChange'
]);
export const WppPill = defineContainer('wpp-pill-v3-6-0', defineWppPill, [
    'value',
    'size',
    'type',
    'disabled',
...
export const WppPillGroup = defineContainer('wpp-pill-group-v3-6-0', defineWppPillGroup, [
    'name',
    'size',
    'value',
    'type',
...
export const WppPopover = defineContainer('wpp-popover-v3-6-0', defineWppPopover, [
    'config',
...
export const WppProgressIndicator = defineContainer('wpp-progress-indicator-v3-6-0', defineWppProgressIndicator, [
    'width',
    'variant',
    'value',
    'isShowPercentage',
...
export const WppQuillStyles = defineContainer('wpp-quill-styles-v3-6-0', defineWppQuillStyles);
export const WppRadio = defineContainer('wpp-radio-v3-6-0', defineWppRadio, [
    'name',
    'value',
    'checked',
    'required',
...
export const WppRadioGroup = defineContainer('wpp-radio-group-v3-6-0', defineWppRadioGroup, [
    'value',
    'required',
    'message',
    'messageType',
...
export const WppRichtext = defineContainer('wpp-richtext-v3-6-0', defineWppRichtext, [
    'name',
    'required',
    'disabled',
    'autoFocus',
...
export const WppRichtextCommonStyles = defineContainer('wpp-richtext-common-styles-v3-6-0', defineWppRichtextCommonStyles);
export const WppRichtextHtml = defineContainer('wpp-richtext-html-v3-6-0', defineWppRichtextHtml, [
    'value'
]);
export const WppRichtextIconLoader = defineContainer('wpp-richtext-icon-loader-v3-6-0', defineWppRichtextIconLoader);
export const WppRichtextMarkdown = defineContainer('wpp-richtext-markdown-v3-6-0', defineWppRichtextMarkdown, [
    'value'
]);
export const WppRichtextView = defineContainer('wpp-richtext-view-v3-6-0', defineWppRichtextView, [
    'value',
    'format',
    'debug',
    'formats',
...
export const WppSearch = defineContainer('wpp-search-v3-6-0', defineWppSearch, [
    'name',
    'loading',
    'disabled',
    'autoFocus',
...
export const WppSegmentedControl = defineContainer('wpp-segmented-control-v3-6-0', defineWppSegmentedControl, [
    'size',
    'hugContentOff',
    'width',
    'variant',
...
export const WppSegmentedControlItem = defineContainer('wpp-segmented-control-item-v3-6-0', defineWppSegmentedControlItem, [
    'size',
    'active',
    'disabled',
    'value',
...
export const WppSelect = defineContainer('wpp-select-v3-6-0', defineWppSelect, [
    'consistentSearch',
    'value',
    'list',
    'type',
...
export const WppSideModal = defineContainer('wpp-side-modal-v3-6-0', defineWppSideModal, [
    'actionsConfig',
    'open',
    'size',
    'disableOutsideClick',
...
export const WppSkeleton = defineContainer('wpp-skeleton-v3-6-0', defineWppSkeleton, [
    'variant',
    'animation',
    'width',
    'height'
]);
export const WppSlider = defineContainer('wpp-slider-v3-6-0', defineWppSlider, [
    'name',
    'inputWidth',
    'value',
    'marks',
...
export const WppSortButton = defineContainer('wpp-sort-button-v3-6-0', defineWppSortButton, [
    'name',
    'ariaProps',
    'disabled',
    'autoFocus'
]);
export const WppSpinner = defineContainer('wpp-spinner-v3-6-0', defineWppSpinner, [
    'color',
    'size',
    'ariaProps'
]);
export const WppStep = defineContainer('wpp-step-v3-6-0', defineWppStep, [
    'active',
    'completed',
    'completedLine',
    'substep',
...
export const WppStepper = defineContainer('wpp-stepper-v3-6-0', defineWppStepper, [
    'activeStep',
    'stepAmount',
    'completedSteps',
    'stepperWidth',
...
export const WppStickyBar = defineContainer('wpp-sticky-bar-v3-6-0', defineWppStickyBar, [
    'variant',
    'barTitle',
    'offsetFromTop',
    'zIndex',
...
export const WppTab = defineContainer('wpp-tab-v3-6-0', defineWppTab, [
    'active',
    'disabled',
    'value',
    'counter',
...
export const WppTabs = defineContainer('wpp-tabs-v3-6-0', defineWppTabs, [
    'value',
    'size',
    'ariaProps',
    'locales',
...
export const WppTag = defineContainer('wpp-tag-v3-6-0', defineWppTag, [
    'variant',
    'maxLabelLength',
    'tooltipConfig',
    'label',
...
export const WppTextareaInput = defineContainer('wpp-textarea-input-v3-6-0', defineWppTextareaInput, [
    'name',
    'value',
    'placeholder',
    'required',
...
export const WppTimePicker = defineContainer('wpp-time-picker-v3-6-0', defineWppTimePicker, [
    'size',
    'disabled',
    'dropdownConfig',
    'placeholder',
...
export const WppToast = defineContainer('wpp-toast-v3-6-0', defineWppToast, [
    'variant',
    'index',
    'message',
    'header',
...
export const WppToastContainer = defineContainer('wpp-toast-container-v3-6-0', defineWppToastContainer, [
    'maxToastsToDisplay',
    'zIndex'
]);
export const WppToggle = defineContainer('wpp-toggle-v3-6-0', defineWppToggle, [
    'name',
    'value',
    'checked',
    'required',
...
export const WppTooltip = defineContainer('wpp-tooltip-v3-6-0', defineWppTooltip, [
    'disabled',
    'header',
    'text',
    'value',
...
export const WppTopbar = defineContainer('wpp-topbar-v3-6-0', defineWppTopbar, [
    'navigation',
    'value',
    'nativeLink',
    'zIndex',
...
export const WppTopbarItem = defineContainer('wpp-topbar-item-v3-6-0', defineWppTopbarItem, [
    'navigation',
    'firstLevel',
    'menu',
    'active',
...
export const WppTree = defineContainer('wpp-tree-v3-6-0', defineWppTree, [
    'data',
    'search',
    'multiple',
    'defaultSelectedIds',
...
export const WppTreeItem = defineContainer('wpp-tree-item-v3-6-0', defineWppTreeItem, [
    'text',
    'multiple',
    'search',
    'item',
...
export const WppTypography = defineContainer('wpp-typography-v3-6-0', defineWppTypography, [
    'type',
    'tag',
    'color'
]);
export const WppVideoPlayer = defineContainer('wpp-video-player-v3-6-0', defineWppVideoPlayer, [
    'src',
    'thumbnail',
    'caption',
    'type',
